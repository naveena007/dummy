...
public class RecruitmentAjaxHandlerAction extends ActionSupport implements ServletRequestAware, ServletResponseAware {
    ...
    private String profileSelectionCost;
    

	public String getProfileSelectionCost() {
		return profileSelectionCost;
	}

	public void setProfileSelectionCost(String profileSelectionCost) {
		this.profileSelectionCost = profileSelectionCost;
	}
    ...
    public String doDownloadResults() throws Exception {
        try {
            ...
            System.out.println("query generated grid download ----->"+getGridDownload());
            System.out.println("query generated grid download flag -------->"+getGridDownloadFlag());
            System.out.println("query generated grid pdf header -------->"+getPdfHeaderName());
...
*/
   ...
   /*public String rateCardTitleCount() {
	      
       System.out.println("********************RecruitmentAjaxHandlerAction :: rateCardTitleCount() Action Start*********************");
     ...
     if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
         try {
      	   setUserSessionId(Integer.parseInt(
              ...
              responseMessage = ServiceLocator.getRecruitmentAjaxHandlerService().rateCardTitleCount(this);
       ...
       System.out.println("********************RecruitmentAjaxHandlerAction :: rateCardTitleCount() Action End*********************");
     return null;
 }*/
         ...
         if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
           try {
        	   setUserSessionId(Integer.parseInt(
				...
				setSessionOrgId(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.ORG_ID).toString()));
				boolean isRateCard = com.mss.msp.util.DataSourceDataProvider.getInstance().getRateCardExistOrNot(this.getJobTitle());
				if(isRateCard==false){
                responseMessage = ServiceLocator.getRecruitmentAjaxHandlerService().insertOrUpdateRatecard(this);
				}
				else{
					responseMessage="RateCard Already Existed";
				}
               int Response = Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString());
               httpServletResponse.setHeader("Cache-Control", "no-cache, no-store, must-revalidate");
               httpServletResponse.setHeader("Pragma", "no-cache");
    ...
    * Author :
    *
    * Method: insertOrUpdateSecurityDeposit() method can be used to insert or update security deposit
    *     
    * *****************************************************************************
    */
   public String insertOrUpdateSecurityDeposit() {
      
         System.out.println("********************RecruitmentAjaxHandlerAction :: insertOrUpdateSecurityDeposit() Action Start*********************");
       if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
           try {
        	   setUserSessionId(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
				setSessionOrgId(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.ORG_ID).toString()));
               String responseMessage = ServiceLocator.getRecruitmentAjaxHandlerService().insertOrUpdateSecurityDeposit(this);
               //int Response = Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString());
               httpServletResponse.setHeader("Cache-Control", "no-cache, no-store, must-revalidate");
               httpServletResponse.setHeader("Pragma", "no-cache");
               httpServletResponse.setDateHeader("Expires", 0);
         ...
         System.out.println("********************RecruitmentAjaxHandlerAction :: insertOrUpdateSecurityDeposit() Action End*********************");
       return null;
   }
   ...
   public String getSecurityDepositDetails() {
         ...
         System.out.println("********************RecruitmentAjaxHandlerAction :: getSecurityDepositDetails() Action Start*********************");
       if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
           try {
        	   setUserSessionId(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
				setSessionOrgId(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.ORG_ID).toString()));
               String resultString = ServiceLocator.getRecruitmentAjaxHandlerService().getSecurityDepositDetails(getRequirementId());
               //int Response = Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString());
               httpServletResponse.setHeader("Cache-Control", "no-cache, no-store, must-revalidate");
               httpServletResponse.setHeader("Pragma", "no-cache");
               httpServletResponse.setDateHeader("Expires", 0);
   ...
   public String getSecurityDepoForReq(){
   
   System.out.println("********************RecruitmentAjaxHandlerAction :: getSecurityDepoForReq() Action Start*********************");
   if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
       try {
    	   setUserSessionId(Integer.parseInt(
					httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
			setSessionOrgId(Integer.parseInt(
					httpServletRequest.getSession(false).getAttribute(ApplicationConstants.ORG_ID).toString()));
           String resultString = ServiceLocator.getRecruitmentAjaxHandlerService().getSecurityDepoForReq(getSessionOrgId(),getSecurityDepositId());
           //int Response = Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString());
           httpServletResponse.setHeader("Cache-Control", "no-cache, no-store, must-revalidate");
           httpServletResponse.setHeader("Pragma", "no-cache");
           httpServletResponse.setDateHeader("Expires", 0);
     ...
     System.out.println("********************RecruitmentAjaxHandlerAction :: getSecurityDepoForReq() Action End*********************");
   return null;
   }
   public String getAllSecurityDepositList(){
	   ...
	   if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
	       try {
	    	   setUserSessionId(Integer.parseInt(
				...
				setSessionOrgId(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.ORG_ID).toString()));
	           String resultString = ServiceLocator.getRecruitmentAjaxHandlerService().getAllSecurityDepositList(getSessionOrgId());
	           //int Response = Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString());
	           httpServletResponse.setHeader("Cache-Control", "no-cache, no-store, must-revalidate");
	           httpServletResponse.setHeader("Pragma", "no-cache");
	           httpServletResponse.setDateHeader("Expires", 0);
...
public String getSecurityDepositAmountsListLoad(){
	   
	   System.out.println("********************RecruitmentAjaxHandlerAction :: getSecurityDepositAmountsListLoad() Action Start*********************");
	   if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
	       try {
	    	   setUserSessionId(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
	           ...
	           String resultString = ServiceLocator.getRecruitmentAjaxHandlerService().getSecurityDepositAmountsListLoad(getSessionOrgId(),typeOfUser);
	           //int Response = Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString());
	           httpServletResponse.setHeader("Cache-Control", "no-cache, no-store, must-revalidate");
	           httpServletResponse.setHeader("Pragma", "no-cache");
	           httpServletResponse.setDateHeader("Expires", 0);
	     ...
	     System.out.println("********************RecruitmentAjaxHandlerAction :: getSecurityDepositAmountsListLoad() Action End*********************");
	   return null;
	   }
   
public String checkBgAttachmentExistOrNot(){
  	
  	resultType = LOGIN;
      String reponseString = "";
      try {
          System.out.println("********************RecruitmentAjaxHandlerAction :: checkBgAttachmentExistOrNot() Action Start*********************");
          if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
              int userSessionId=(Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
              int userSessionOrgId=(Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.ORG_ID).toString()));
             //
...
//                      setConsult_AttachmentLocation(DataSourceDataProvider.getInstance().getConsultVisaAttachment(getConsult_id()));
//                  } else {
                     String result= DataSourceDataProvider.getInstance().getBackground_AttachmentLocation(this.getAcc_attachment_id());
            System.out.println("-0----------------------------------------->"+result);
                      setConsult_AttachmentLocation(result);
//                  }
          ...
          resultType = ERROR;
           ...
           System.out.println("********************RecruitmentAjaxHandlerAction :: checkBgAttachmentExistOrNot() Action End*********************");
      return null;
