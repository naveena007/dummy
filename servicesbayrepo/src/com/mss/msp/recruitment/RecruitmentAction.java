...
public class RecruitmentAction extends ActionSupport implements ServletRequestAware, ServletResponseAware {
	...
	private String vendorTiers;
	private String fromDate;
	private String toDate;
	private String securityDepositTitle;
	private String venDashboard;
    ...
    private int pgNo;
    private int pgFlag;
    private int ucurrent_orgid;
    private String ucurrent_pageFlag;
    private String ucurrent_vendor;
    private int current_orgid;
    private String current_pageFlag;
    private String current_vendor;
    private int vcurrent_orgid;
    private String vcurrent_pageFlag;
    private String vcurrent_vendor;
    private boolean fakeCandidate;
    private String interviewNotificationStatus;
	private int account_id;
	
	
	private List<SecurityDepositVTO> securityDepositVTO;
	
	
	
	public List<SecurityDepositVTO> getSecurityDepositVTO() {
		return securityDepositVTO;
	}

	public void setSecurityDepositVTO(List<SecurityDepositVTO> securityDepositVTO) {
		this.securityDepositVTO = securityDepositVTO;
	}

	public int getUcurrent_orgid() {
		return ucurrent_orgid;
	}

	public void setUcurrent_orgid(int ucurrent_orgid) {
		this.ucurrent_orgid = ucurrent_orgid;
	}

	public String getUcurrent_pageFlag() {
		return ucurrent_pageFlag;
	}

	public void setUcurrent_pageFlag(String ucurrent_pageFlag) {
		this.ucurrent_pageFlag = ucurrent_pageFlag;
	}

	public String getUcurrent_vendor() {
		return ucurrent_vendor;
	}

	public void setUcurrent_vendor(String ucurrent_vendor) {
		this.ucurrent_vendor = ucurrent_vendor;
	}

	public int getCurrent_orgid() {
		return current_orgid;
	}

	public void setCurrent_orgid(int current_orgid) {
		this.current_orgid = current_orgid;
	}

	public String getCurrent_pageFlag() {
		return current_pageFlag;
	}

	public void setCurrent_pageFlag(String current_pageFlag) {
		this.current_pageFlag = current_pageFlag;
	}
	...
	public void setCurrent_vendor(String current_vendor) {
		this.current_vendor = current_vendor;
	}

	public int getVcurrent_orgid() {
		return vcurrent_orgid;
	}

	public void setVcurrent_orgid(int vcurrent_orgid) {
		this.vcurrent_orgid = vcurrent_orgid;
	}

	public String getVcurrent_pageFlag() {
		return vcurrent_pageFlag;
	}

	public void setVcurrent_pageFlag(String vcurrent_pageFlag) {
		this.vcurrent_pageFlag = vcurrent_pageFlag;
	}

	public String getVcurrent_vendor() {
		return vcurrent_vendor;
	}

	public void setVcurrent_vendor(String vcurrent_vendor) {
		this.vcurrent_vendor = vcurrent_vendor;
	}

	public String getVenDashboard() {
		return venDashboard;
	}

	public void setVenDashboard(String venDashboard) {
		this.venDashboard = venDashboard;
	}
	...
	private String consultantAddFlag;
	...
	private int current_attachmentId;
	private String backgroundStatus;
	private String verifiedBy;
	private String backgroundCheckComments;
	private String verificationComments;
	private String verificationStatus;
	private String overlayFlag;
	private String jspPageFlag;
	private Map csrList;//csrList is used to get all csr associated with particular organization.
	private List specializationList;
	private String conRejectionComments;
	...
	public String getConsultantAddFlag() {
		return consultantAddFlag;
	}

	public void setConsultantAddFlag(String consultantAddFlag) {
		this.consultantAddFlag = consultantAddFlag;
	}
	...
	public String doAddConsultant() {
		...
		try {
			...
			setReqCategory(dataSourceDataProvider.getInstance().getAllSkills(1));
			...
			//Map skillsmap = (Map) session.get("skillsmap");
			 //setReqCategory(skillsmap);
			 //setSkillValuesMap(skillsmap);
			setSkillValuesMap(dataSourceDataProvider.getInstance().getAllSkills(1));
	...
	public String techReviewForward() {
		...
		int result = 0, mailResult = 0, conMailResult = 0, csrMailResult = 0;
		try {
			if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
				setUserSessionId(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
				...
				setVendorName(dataSourceDataProvider.getInstance().getVendorNameByConIdAndReqId(getRequirementId(),getConsult_id() ));
				...
				if (result > 0) {
					...
					if ("Online".equals(getInterviewType()) || "Psychometric".equals(getInterviewType())) {
						...
						csrMailResult = mailManager.techReviewMailToCSRS(this, getSessionOrgId());
					...
					if (mailResult > 0 && conMailResult > 0 && csrMailResult > 0) {
					}
				}
				httpServletResponse.setHeader("Cache-Control", "no-cache, no-store, must-revalidate");
				httpServletResponse.setHeader("Pragma", "no-cache");
	...
	public String getConsultantProfile() {
		...
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			...
			try {
				...
				consultantVTO = ServiceLocator.getRecruitmentService().getConsultantProfile(this, getSkillValuesMap());
				setPermanentState(
						DataSourceDataProvider.getInstance().getPermanentStates(consultantVTO.getConsult_Country()));
				setCurrentState(
						DataSourceDataProvider.getInstance().getPermanentStates(consultantVTO.getConsult_CCountry()));
		...
		System.out.println("********************RecruitmentAction :: getConsultantProfile Method End*********************");
		return resultType;
	...
	public String consultBackgroundUpload() {
		...
		try {
			if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString() != null) {
				...
				addresult = ServiceLocator.getRecruitmentService().addBackgroundAttachmentDetails(this);
				if (addresult > 0) {
					setTabFlag("attachmentTab");
				} else {
				}
	...
	// consultBackgroundUploadInitiation
			...
			try {
				if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString() != null) {
					if (getConsultBackgroundAttachmentFileName() == null) {
						...
						String aesKeyString = Properties.getProperty("AES_KEY");
						setFilePath(DataSourceDataProvider.getInstance().createFileInFileSystem(basefilePath,
								consultBackgroundAttachmentFileName, consultBackgroundAttachment, aesKeyString));
						System.out.println("consultBackgroundUpload--->" + getFilePath());
		...
		// This method is used to update the back ground status.
		public String consultBackgroundStatusUpdate() {
			resultType = LOGIN;
			int addresult = 0;
			System.out.println(
					"********************RecruitmentAction :: consultBackgroundStatusUpdate Method Start*********************");
			try {
				if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString() != null) {
					if (getBackgroundStatus().equalsIgnoreCase("Initiated")) {
						System.out.println("attachment file name " + getConsultBackgroundAttachmentFileName());
						if (getConsultBackgroundAttachmentFileName() == null) {
						} else {
							String basefilePath = Properties.getProperty("Consultant.Background");
							// File createPath = new File(filePath);
						...
						setUserSessionId(Integer.parseInt(httpServletRequest.getSession(false)
								.getAttribute(ApplicationConstants.USER_ID).toString()));
						setAttachmentType(getBackgroundAttachmentType());

						setConsultAttachmentFileName(getConsultBackgroundAttachmentFileName());
						setAttachmentTitle(getBackgroundAttachmentTitle());
						addresult = ServiceLocator.getRecruitmentService().consultBackgroundStatusUpdate(this);
						if (addresult > 0) {
							setTabFlag("attachmentTab");
						} else {
						}
			...
			System.out.println(
					"********************RecruitmentAction :: consultBackgroundStatusUpdate Method End*********************");
			return SUCCESS;
		}
		
		
		
		public String getSecurityDepositList() {
			resultMessage = LOGIN;
			System.out.println(
					"********************RecruitmentAction :: getRateCardList Method Start*********************");
			if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
				try {
					...
					securityDepositVTO = ServiceLocator.getRecruitmentService().getSecurityDepositList(this);
					// setReqCategory(dataSourceDataProvider.getInstance().getRequiteCategory(1));
					/*
					 * if (requirementlistVTO.size() == 0) {
					 * setRequirementlistVTO(null); }
		...
		public String getSecurityDepositAmountsList() {
			resultMessage = LOGIN;
			System.out.println(
					"********************RecruitmentAction :: getSecurityDepositAmountsList Method Start*********************");
			if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
				try {
					resultMessage = SUCCESS;
				} catch (Exception ex) {
			...
			System.out.println(
					"********************RecruitmentAction :: getSecurityDepositAmountsList Method End*********************");
			return resultMessage;
		}
		 ...
		 * Author :
		 *
		 * ForUse : forwardTechReviewToVendor() method is used to forward consultant
		 * technical review to vendor and also send notification mail to vendor
		 *
		 * *****************************************************************************
		 */
		public String forwardTechReviewToVendor() {
			resultMessage = LOGIN;
			int venMailResult = 0;
			String finalResult="false";
			RecruitmentAction recruitmentAction = new RecruitmentAction();
			System.out.println(
					"********************RecruitmentAction :: forwardTechReviewToVendor Method Start*********************");
			if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
				try {
					int usrId=Integer.parseInt(httpServletRequest.getSession(false)
							.getAttribute(ApplicationConstants.USER_ID).toString());
					int result = dataSourceDataProvider.getInstance().updateInterviewNotificationStatusByCSR(getContechId(),
							getInterviewNotificationStatus(),usrId);
					if (result > 0) {
						recruitmentAction = ServiceLocator.getRecruitmentService()
								.getConTechnicalReviewsById(getContechId());
						recruitmentAction.setUserSessionId(usrId);
						dataSourceDataProvider.getInstance().getVendorEmpEmail(recruitmentAction);
						setReqName(
								DataSourceDataProvider.getInstance().getReqNameById(recruitmentAction.getRequirementId()));
						venMailResult = mailManager.techReviewMailToVendor(recruitmentAction);
					...
					httpServletResponse.setContentType("text");
					httpServletResponse.setCharacterEncoding("UTF-8");
					httpServletResponse.getWriter().write(finalResult);
			...
			System.out
					.println("********************RecruitmentAction :: forwardTechReviewToVendor Method End*********************");
			return null;
		}
		 ...
		 *
		 * ForUse : forwardTechReviewToVendor() method is used to forward consultant
		 * technical review to consultant and also send notification mail to consultant.
		 *
		 * *****************************************************************************
		 */
		public String forwardTechReviewToConsultant() {
			resultMessage = LOGIN;
			int conMailResult = 0;
			String finalResult="false";
			RecruitmentAction recruitmentAction = new RecruitmentAction();
			System.out.println(
					"********************RecruitmentAction :: forwardTechReviewToConsultant Method Start*********************");
			if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
				try {
					int result = dataSourceDataProvider.getInstance().updateInterviewNotificationStatus(getContechId(),
							getInterviewNotificationStatus(),"");
					if (result > 0) {
						recruitmentAction = ServiceLocator.getRecruitmentService()
								.getConTechnicalReviewsById(getContechId());
						recruitmentAction.setUserSessionId(Integer.parseInt(httpServletRequest.getSession(false)
								.getAttribute(ApplicationConstants.USER_ID).toString()));
						conMailResult = mailManager.techReviewConsultantEmailGenerator(recruitmentAction);
						System.out.println("result is "+result);
			...
			System.out
					.println("********************RecruitmentAction :: forwardTechReviewToConsultant Method End*********************");
			return null;
		}
		 ...
		 * Author :
		 *
		 * ForUse : submitConInterviewNotification() method is used to consultant accept or reject the technical review.
		 *
		 * *****************************************************************************
		 */
		public String submitConInterviewNotification() {
			resultMessage = LOGIN;
			int conMailResult = 0;
			String finalResult="false";
			RecruitmentAction recruitmentAction = new RecruitmentAction();
			System.out.println(
					"********************RecruitmentAction :: AcceptTechnicalReview Method Start*********************");
			if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
				try {
					int result = dataSourceDataProvider.getInstance().updateInterviewNotificationStatus(getContechId(),getInterviewNotificationStatus(),getConRejectionComments());
					if (result > 0) {
						recruitmentAction = ServiceLocator.getRecruitmentService().getConTechnicalReviewsById(getContechId());
						conMailResult = mailManager.conAcceptanceMail(recruitmentAction);
						System.out.println("result is "+result);
			...
			System.out
					.println("********************RecruitmentAction :: submitConInterviewNotification Method End*********************");
			return null;
		}
	...
	public int getCurrent_attachmentId() {
		return current_attachmentId;
	}

	public void setCurrent_attachmentId(int current_attachmentId) {
		this.current_attachmentId = current_attachmentId;
	}
	...
	public String getBackgroundCheckComments() {
		return backgroundCheckComments;
	}

	public void setBackgroundCheckComments(String backgroundCheckComments) {
		this.backgroundCheckComments = backgroundCheckComments;
	}
	...
	public void setOverlayFlag(String overlayFlag) {
	...
	public Map getCsrList() {
		return csrList;
	}

	public void setCsrList(Map csrList) {
		this.csrList = csrList;
	}

	public String getVendorTiers() {
		return vendorTiers;
	}

	public void setVendorTiers(String vendorTiers) {
		this.vendorTiers = vendorTiers;
	}
	...
	public String getSecurityDepositTitle() {
		return securityDepositTitle;
	}

	public void setSecurityDepositTitle(String securityDepositTitle) {
		this.securityDepositTitle = securityDepositTitle;
	}
	...
	public boolean isFakeCandidate() {
		return fakeCandidate;
	}

	public void setFakeCandidate(boolean fakeCandidate) {
		this.fakeCandidate = fakeCandidate;
	}
	
	

	public String getInterviewNotificationStatus() {
		return interviewNotificationStatus;
	}

	public void setInterviewNotificationStatus(String interviewNotificationStatus) {
		this.interviewNotificationStatus = interviewNotificationStatus;
	}
	...
	public String getConRejectionComments() {
		return conRejectionComments;
	}

	public void setConRejectionComments(String conRejectionComments) {
		this.conRejectionComments = conRejectionComments;
	}
