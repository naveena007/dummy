...
<body oncontextmenu="return false" ng-app="myApp" ng-controller="myCtrl" onload="getSecurityDepositDetails('onload')">
	<div id="wrap">
		<header id="header">
			<!--header-->
						...
						<ul class="nav nav-tabs">
							<s:if test="vendor!='yes'">
								<li class=" active_details" id="detailsLi"><a
									aria-expanded="false" href="#details"
									onclick=" pagerOption12();" data-toggle="tab">Add
										Consultant For Job </a></li>
							</s:if>
							<s:if test="vendor=='yes'">
								<li class=" active_details" id="detailsLi"><a
									aria-expanded="false" href="#details" data-toggle="tab">Available&nbsp;Consultants</a>
								</li>
							</s:if>

							<li class="active_details" id="consultantListLi"><a
								aria-expanded="false" href="#consultantList"
								onclick=" pagerOptionSL();" data-toggle="tab">Submitted&nbsp;Profiles</a></li>
								...
								<div class="" id="selectivityProfileBox"
									...
									<div class="backgroundcolor">
										...
										<span class="pull-right"><s:a href='%{#myUrl}'>
											...
											<s:else>
											<s:url var="myUrl"
												action="../../dashboard/getVendorRequirementsDashboards.action">
											</s:url>
											</s:else>
											<span class="pull-right"><s:a href='%{#myUrl}'>
											<img src="<s:url value="/includes/images/backButton.png"/>" height="25" width="25">
											</s:a></span>
									</div>
										...
										<div class="" id="selectivityProfileBox"
											...
											<div class="col-sm-12" style="margin-top: 1%">
												...
												<div class="col-sm-3"
													...
													<label class=""> Skill Set :</label> <span
														style="color: #FF8A14;"><s:property
															value="%{reqSkill}" /></span>
													<s:hidden name="reqSkillSet" id="reqSkillSet"
														value="%{reqSkillSet}" />
													<s:hidden name="reqSkill" id="reqSkill"
														value="%{reqSkill}" />
												</div>
											</div>
											...
											<div class="inner-reqdiv-elements">
												<s:form action="storeProofData" theme="simple"
													...
													<span><e1></e1></span>
										<s:hidden name="venDashboard" id="venDashboard" value="%{venDashboard}" />
													...
													<s:hidden name="selectedContactType"
														id="selectedContactType" />
														...
														<div class="col-sm-6">
															...
															<div class="col-sm-12">
																...
																<s:textfield name="conEmail" id="conEmail"
																	...
																	cssClass="form-control" tabindex="1" maxlength="60"
																	ng-keyup="getEmployeesList()"
																	ng-model="conEmail.searchKey" />

															</div>

															<div class="col-sm-6 selectivity_block" style="border: 1px dashed gray;" autocomplete='off'>

																<div class="suggestionList1">
																	<div ng-repeat="consultant in consultants"
																		ng-model="consultant"
																		ng-click="selectEmploye(consultant)">
																		<a href="" class="suggestionList">{{consultant.Email}}
																		</a>
																	</div>
																</div>
															</div>
															...
															<div class="col-sm-12">
																...
																<div class="calImage">
																	<s:textfield cssClass="form-control"
																		name="availableFrom" id="availableFrom"
													...
													<div class="row">
														<div class="col-sm-3  ">
															<div class="col-sm-12">
																...
																<s:textfield cssClass="form-control" name="rateFrom"
																	id="rateFrom" tabindex="7" placeholder="From"
																	style="float:left;">
														...
														<div class="col-sm-3  ">
															<div class="col-sm-12">
																...
																<s:textfield cssClass="form-control" name="rateTo"
																	id="rateTo" tabindex="7" placeholder="To">
														...
														<div class="col-sm-6">
															<div class="col-sm-7 pull-right"
																style="display: none;padding-top: 35px" id="securityDepositViewBtn" >
																<button type="button" Style="margin-right: 10px;"
																	Class="add_searchButton form-control addAuthAccOverlay_popup_open"
																	value="" onclick="return getSecurityDepositDetails('onclick')"
																	tabindex="5">
																	<i class=" fa fa-eye"></i>&nbsp;View Security Deposit
																	Policies
																</button>
															</div>
															...
															<div class="col-sm-0">
																<div class="col-sm-4 pull-right"
																	...
																	<button type="button" Style="margin-right: 10px;"
																		id="addConSubmit"
																		Class="add_searchButton form-control" value=""
																		onclick="return getAvailableConsultantDetails()"
																		tabindex="5">
													...
													<div class="task_content" id="colnsultant_div"
														...
														<div>
															<div>
																...
																<br /> <label class="page_option pull-left">
																	Display <select id="paginationOption12"
																	class="disPlayRecordsCss" onchange="pagerOption12()"
																	style="width: auto">
																		<option>10</option>
																		<option>15</option>
																		<option>25</option>
											...
											<s:form action="" theme="simple">
												...
												<div class="col-sm-3">
													...
													<s:textfield cssClass="form-control" name="consult_name"
														id="consult_name" value="%{consult_name}" tabindex="2"
												...
												<div class="col-sm-3">
													...
													<s:textfield cssClass="form-control" name="consult_lstname"
														id="consult_lstname" value="%{consult_lstname}"
														tabindex="3" maxLength="30" placeholder="Last Name" />
												...
												<div class="col-sm-3">
													...
													<div class="input-group">
														<s:textfield cssClass="form-control" name="consult_ssnNo"
															id="consult_ssnNo" placeholder="SSN Number" tabindex="4"
															value="%{consult_ssnNo}" />
												...
												<s:if test="vendor=='yes'">
													<div class="col-sm-3">
														...
														<s:textfield cssClass="form-control" name="consult_email"
															id="consult_email" value="%{consult_email}" tabindex="5"
															maxLength="60" placeholder="Email Id" />
												...
												<div class="col-sm-3">
													...
													<s:textfield cssClass="form-control" name="consult_skill"
														id="consult_skill" value="%{consult_skill}" tabindex="6"
														maxLength="100" placeholder="Skill Set" />
												</div>
												<div class="col-sm-3">
													<label class="labelStylereq" style="color: #56a5ec">Experience</label>
													<s:textfield cssClass="form-control" name="yearExperience"
														id="yearExperience" placeholder="Experience" value=""
												...
												<div class="col-sm-3 pull-right">
													...
													<div class="pull-right contact_search">
														...
														<s:submit type="button"
															...
															id="searchButton" tabindex="7" cssStyle="margin:5px 0px;"
															value="" onclick="return getConsultantListBySearch();">
									...
									<div class="col-sm-12" style="overflow-x: auto">
										<s:form>
											...
											<div class="task_content" id="task_div" align="center"
												style="display: none">
                                                        <div id="loadingsubmitted" class="loadingImg" style="display:none">
										...
										<div id="recruiterBox" class="marginTasks">
											...
											<div>
												<form>
														...
														<table>
															...
															<div class="inner-techReviewdiv-elements">
																<s:textfield cssClass="form-control "
																	...
																	name="migrationEmailId" placeholder="" label="EmailId"
													...
													<br />
													<s:submit cssClass="cssbutton migrationButton" id="migrate"
														onclick="return userMigration();" value="Migrate" />
												</form>
											</div>
					...
					<div class="backgroundcolor">
						<table>
							<tr>
								...
								<span class="pull-right">
									<h5>
										&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" id="withdrawCommentsClose"
											class="conWithdraw_popup_close"
			...
			<div id="addAuthAccOverlay_popup">
				<div id="addAuthAccBox">
					<div class="backgroundcolor">
						<table>
							<tr>
								<td><h4 id="" style="font-family: cursive">
										<font id="overlayHeading" class="titleColor">Security
											Deposit Policies</font>
									</h4></td>
								<span class="pull-right">
									<h5>
										&nbsp;&nbsp;&nbsp;&nbsp;<a href="" id="authAddCloseButton"
											class="addAuthAccOverlay_popup_close"
											onclick="securityDepositOverlayFun();"><i
											class="fa fa-times-circle-o fa-size"></i></a>
									</h5>
								</span>
						</table>
					...
					<div>
						...
						<s:hidden id="overlayUserId"/>
						<s:hidden id="overlayRequirementId"/>

						<div class="overlayFormFields" id="">
							...
							<s:textfield id="overlayProfileSubmissionCost"
								...
								onkeyup="rateValidation(this);" readonly="true" />
						</div>
						<div class="overlayFormFields" id="">
							<label class="addAcclabelStyle" style="color: #56a5ec;">Profile
								Selected Cost ($)</label>
						...
						<div class="overlayFormFields" id="descDiv">
							...
							<s:textarea id="overlayComments" cssClass="form-control"
								...
								onfocus="return removeErrorMsg();" readonly="true"/>

						</div>
                       
                       <div id="securityDepositConsultantSubmitBtn">
						<div class="col-sm-4" style="margin-left: 125px">
							<s:checkbox label="Agree" id="securityDepositAgree"
								name="securityDeposit" onclick="securityDepositAggrement();"/>
						</div>
						<div class="col-sm-4 pull-right" style="margin-right: 20px">
							<button type="button" Style=";"
								id="addConSubmit" Class="add_searchButton form-control"
								onclick="submitConsulatntProfileToRequirement();" tabindex="5" >
	...
	<script type="text/javascript">
		...
		function pagerOption12() {
			...
			initSessionTimer();
			var paginationSize = document.getElementById("paginationOption12").value;
	...
	<script type="text/javascript">
		...
		function pagerOptionSL() {
			...
			initSessionTimer();
			var paginationSize = document.getElementById("paginationOptionSL").value;
			if (isNaN(paginationSize)) {
