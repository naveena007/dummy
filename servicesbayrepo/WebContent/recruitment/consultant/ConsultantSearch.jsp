...
<link rel="stylesheet" type="text/css"
 ...
 <link rel="stylesheet" type="text/css"
	href="<s:url value="/includes/css/general/selectivity-full.css"/>">getReleaseVendors
<script type="text/JavaScript"
...
<script>
	...
	function selectedItems() {
		 var selectObj = document.getElementById("skillCategoryValue");
		/*  $("#skillCategoryValue").multiselect({
			   selectedText: "# of # selected"
			}); */
		 var selVal = document.getElementById("skillValues").value;
		  //alert(selVal);
		   var selectedOptions = selVal.split(",");

		    for(var i in selectedOptions) {
			    var optionVal = selectedOptions[i];
			    //alert(optionVal);
			    //$("#skillCategoryValue").find("option[value="+optionVal+"]").prop("selected", true);
			      $("#skillCategoryValue option[value='" + optionVal + "']").prop("selected", true);
			} 
		  // $("#skillCategoryValue").multiselect('refresh');
		  $("#skillCategoryValue").trigger("change");
	 }
</script>
<sx:head />
...
<body style="overflow-x: hidden" oncontextmenu="return false"
	onload="consultantPage();StateChange();selectedItems();jumper();">
	<div id="wrap">
		<header id="header">
			<!--header-->
													...
													<div class="inner-reqdiv-elements">
														...
														<div class="col-sm-4">
															...
															<s:textfield cssClass="form-control"
																...
																placeholder="Experience" value="%{yearExperience}" tabindex="8"
															    maxLength="15" />
														</div>
