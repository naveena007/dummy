...
<html>
    ...
    <body oncontextmenu="return false" onload=" setPaybleDetails(); onloadDate();">
        <div id="wrap">
            <div id="generalForm">
                                                ...
                                                <s:if test="invoiceVTOClass.status=='Approved' || invoiceVTOClass.status=='Rejected'|| invoiceVTOClass.status=='Paid'">
                                                    ...
                                                    <s:if test="invoiceVTOClass.status=='Approved' || invoiceVTOClass.status=='Rejected' || invoiceVTOClass.status=='Paid'">
                                                        ...
                                                        <s:if test="invoiceVTOClass.status=='Approved' || invoiceVTOClass.status=='Rejected' || invoiceVTOClass.status=='Paid'">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <s:if test="invoiceVTOClass.status!='Rejected'">
                                                                    <label class="labelStylereq" tabindex="6" style="color:#56a5ec">Approved Date</label>
                                                                </s:if>
                                                                <s:else>
                                                                    <label class="labelStylereq" tabindex="7" style="color:#56a5ec">Rejected Date</label>
                                                                </s:else>
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <label class="labelStylereq" style="color:#56a5ec">Status</label>
                                                             <s:if test="invoiceVTOClass.status=='Created' && #session.typeOfUsr=='VC'">
                                                            <a href="#" data-toggle="tooltip" data-html="true" data-placement="right"  title="If Status is <b>Submitted</b> then Invoice is Submitted to the Customer">
															   <img src="/sb/includes/images/icons/isymbol.png" width="15" height="15"/>
															</a>
															</s:if>
															<s:elseif test="invoiceVTOClass.status=='Approved' && #session.typeOfUsr!='VC'">
                                                            <a href="#" data-toggle="tooltip" data-html="true" data-placement="right"  title="If Status is <b>Piad</b> then You can make Payment by giving respective <b>Payment Details</b>">
															   <img src="/sb/includes/images/icons/isymbol.png" width="15" height="15"/>
															</a>
															</s:elseif>
                                                    ...
                                                    <div class="col-sm-12" id="paymentData">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="col-sm-12">
                                                            <label class="labelStylereq" style="color:#56a5ec">Vendor Description</label>
                                                            <s:textarea id="vendorDescription" tabindex="26" name="invoiceVTOClass.vendorDescription" maxLength="200" placeholder="Vendor Description" value="%{invoiceVTOClass.vendorDescription}" cssClass=" form-control" onkeyup="descriptionCheckCharacters(this)" />
                                                           <div class="charNum pull-right" id="descriptionCharNum"></div> 
                                                        </div>

                                                    </div>
                                                    <div class="col-sm-12">
                                                        <div class="col-sm-12">
                                                            <label class="labelStylereq" style="color:#56a5ec">Customer Description</label>
                                                            <s:textarea id="customerDescription" tabindex="27" name="invoiceVTOClass.customerDescription" maxLength="200" placeholder="Customer Description" value="%{invoiceVTOClass.customerDescription}" cssClass=" form-control" readonly="true" />
                                                            </div>
													...
													<div class="col-sm-12">
                                                        <div class="col-sm-12">
                                                            <label class="labelStylereq" style="color:#56a5ec">Vendor Description</label>
                                                            <s:textarea id="vendorDescription" tabindex="26" name="invoiceVTOClass.vendorDescription" maxLength="200" placeholder="Vendor Description" value="%{invoiceVTOClass.vendorDescription}" cssClass=" form-control" readonly="true"/>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="col-sm-12">
                                                            <label class="labelStylereq" style="color:#56a5ec">Customer Description</label>
                                                            <s:textarea id="customerDescription" tabindex="27" name="invoiceVTOClass.customerDescription" maxLength="200" placeholder="Customer Description" value="%{invoiceVTOClass.customerDescription}" cssClass=" form-control" onkeyup="descriptionCheckCharacters(this)"/>
                                                            <div class="charNum pull-right" id="descriptionCharNum"></div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-2 pull-right">
                                                            <s:if test="invoiceVTOClass.status!='Paid' ">
                                                                ...
                                                                <s:elseif test="#session.typeOfUsr!='VC'">
                                                                    ...
                                                                    <s:submit id="invoicePaid" type="button" tabindex="28" value="Paid" style="display:none" cssClass="add_searchButton form-control fa fa-money btn_order marqueeText" onclick="return getBalanceAmt();"/>
                                                                </s:elseif>
                                                            </s:if>
