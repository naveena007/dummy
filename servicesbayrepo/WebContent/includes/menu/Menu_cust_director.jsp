                        ...
                        <ul id="homeDisplay">
                           ...
                           <li><a id="requirementUtilitiesCustDirector" href="/<%=ApplicationConstants.CONTEXT_PATH%>/recruitment/consultant/getAllRequirementList.action?orgid=<%=orgId%>" onClick="leftMenuToggleId(this,'homeAdmin');"><img src="<s:url value="/includes/images/icons/requirement.png"/>" height="15" width="15">&nbsp;Requirements&nbsp;</a></li>
                            ...
                            <li><a id="budgetsUtilitiesCustDirector" href="/<%=ApplicationConstants.CONTEXT_PATH%>/budgets/ProjectBudgetDetails.action" onClick="leftMenuToggleId(this,'homeAdmin');"><img src="<s:url value="/includes/images/icons/dollar.png"/>" height="15" width="15">&nbsp;Project&nbsp;Budgets</a></li>
                             <li><a id="submissionsHomeProjectManager" href="/<%=ApplicationConstants.CONTEXT_PATH%>/Requirements/getSubmissionList.action?orgid=<%=orgId%>&pageFlag=submitList" onClick="leftMenuToggleId(this,'homeAdmin');"><i class="fa fa-users" aria-hidden="true" style="color: CornflowerBlue"></i>&nbsp;Submitted&nbsp;Profiles</a></li>
							<li><a id="techReviewHomeCustDirector" href="/<%=ApplicationConstants.CONTEXT_PATH%>/recruitment/consultant/getTechReviewDetails.action?pageFlag=techReviewList" onClick="leftMenuToggleId(this,'homeAdmin');"><img src="<s:url value="/includes/images/icons/review.png"/>" height="15" width="15">&nbsp;Tech&nbsp;Reviews</a></li>
                ...
                <div id="utilitiesMenuCustDirector" class="panel-collapse collapse">
                    <div class="panel-body">
                        <ul id="utilitiesDisplay">
                        	<li><a id="techReviewUtilitiesCustDirector" href="/<%=ApplicationConstants.CONTEXT_PATH%>/recruitment/consultant/getTechReviewDetails.action?pageFlag=techReviewList" onClick="leftMenuToggleId(this,'utilitiesAdmin');"><img src="<s:url value="/includes/images/icons/review.png"/>" height="15" width="15">&nbsp;Tech&nbsp;Reviews</a></li>    
