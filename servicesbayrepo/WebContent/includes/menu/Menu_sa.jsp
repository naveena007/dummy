                ...
                <div id="utilitiesMenuAdmin" class="panel-collapse collapse">
                    <div class="panel-body">
                        <ul id="utilitiesDisplay">
                           ...
                           <li><a id="skillsApprovalUtilitiesMenuAdmin" href="/<%=ApplicationConstants.CONTEXT_PATH%>/users/general/skillsApprovalForConsultant.action" onClick="leftMenuToggleId(this,'utilitiesAdmin');"><i class="fa fa-thumbs-o-up" aria-hidden="true" style="color:CornflowerBlue"></i>&nbsp;Approve&nbsp;Skills&nbsp;</a></li>
