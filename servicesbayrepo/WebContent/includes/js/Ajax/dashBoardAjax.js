...
//		}
    ...
    var options = {
        ...
        colors: ['#0000FF', '#00FF00', '#00BFFF', '#FF0000', '#B637A6'],
        is3D: true,
        pieSliceText: 'value',
...
function getRequirementPieChartDetails(activityType){
    ...
    if(activityType =="Open")
    	 activityType = "O";
    else if(activityType =="Open For Resume")
   	 activityType = "OR";
...
//alert(countVal[0]);
	    ...
	    function drawChart() {
	      var data = google.visualization.arrayToDataTable([
	        ...
	        ["Processing", parseInt(countVal[0]), "#FF4500"],
	        ["Short Listed", parseInt(countVal[1]), "#00BFFF"],
	        ["Selected", parseInt(countVal[2]), "#228B22"],
	        ["Rejected",parseInt(countVal[3]), "#FF0000"],
	        ["Exam Completed",parseInt(countVal[4]), "#CCCC00"]
	      ]);
