...
function removeErrorMessages(){
    ...
    $("#RequirementEnd").css("border", "1px solid #53C2FF");
...
//    }
    ...
    $("#RequirementEnd").css("border", "1px solid #3BB9FF");
