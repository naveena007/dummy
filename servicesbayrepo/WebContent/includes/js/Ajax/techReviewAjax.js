...
function forwardReviewToCustomer() {
	...
	var consultantDate = new Date(interviewTechieDate[2],
			interviewTechieDate[0] - 1, interviewTechieDate[1],
			interviewTechieDate[3], interviewTechieDate[4]);
	var todayDate = new Date();
	// alert(interviewType)
	// alert(interviewType)
	if (interviewType != "Online" && interviewType != "Psychometric") {
		...
		if ($("#interviewDate").val() == "") {
			...
			$("e")
					.html(
							" <font color='red'>Please enter Interview Date</font>");
			flag = false;
			return false;
		} else {
			$("e").html("");
		...
		if (consultantDate < todayDate) {
			$("e")
					.html(
							" <font color='red'>Interview time must be greater than  current time!</font>");
			flag = false;
			return false;
		} else {
			$("e").html("");
		...
		if (interviewType == "Online") {
			...
			if ($("#skillCategoryValue :selected").length == 0) {
				...
				$("e")
						.html(
								" <font color='red'>Please select skills from Skill Set</font>.");
				$("e").show().delay(4000).fadeOut();
			...
			if ($("#skillCategoryValue :selected").length > 10) {
				...
				$("e")
						.html(
								"<font color='red'>Skills should not be selected more than 10</font>");
				// $("e").show().delay(4000).fadeOut();
				// $("e").html(" <b><font color= #FF4D4D>Skills should not be
				// selected more than 10</font></b>.");
				// $("#consult_preferredState").val(" <b><font color=
				// #FF4D4D>Preferred State should not be selected more than
				// 5</font></b>.");
				// $("#skillCategoryValue").css("border","1px solid red");
			...
			if ($("#psychoskillCategoryValue :selected").length == 0) {
				...
				$("e")
						.html(
								" <font color= #FF4D4D>Please Select The skills</font>.");
				// $("e").show().delay(4000).fadeOut();
				// $("#consult_preferredState").val(" <b><font color=
				// #FF4D4D>Preferred State should not be selected more than
				// 5</font></b>.");
		...
		if (techieQuestions < 1) {
			...
			$("e")
					.html(
							" <font color='red'>Please give number of Questions</font>");
			// $("e").show().delay(4000).fadeOut();
			return false;
		} else {
			$("e").html("");
		...
		//            
		// alert("You Must Give Questions");
		// $("e").html(" <b><font color='red'>Please Enter number of
		// Questions</font></b>");
		// $("e").show().delay(4000).fadeOut();
		// return false;
		// }
...
function responseForTechReview(interviewType, flag) {
	...
	if (interviewType == 'Face to Face') {
		if (interviewLocation == "") {
			...
			$("e")
					.html(
							" <font color='red'>Location should not be empty for Face to Face interview</font>");
			flag = false;
		} else {
			$("e").html("");
		}
	...
	if ($('#techReviewAlert').prop('checked')) {
		...
		if (interviewDate < reviewAlertDate) {
			$("e")
					.html(
							" <font color='red'>Alert Date must be less than Interview Date</font>");
			flag = false;
		} else {
			$("e").html("");
		}
		...
		var taskAddStartDate = new Date(splitTaskStartDate[2],
				splitTaskStartDate[0] - 1, splitTaskStartDate[1]); // Y M
		// D
		var splitTaskEndDate = endDate.split('-');
		var taskAddtargetDate = new Date(splitTaskEndDate[2],
				splitTaskEndDate[0] - 1, splitTaskEndDate[1]); // Y M
		// D
		...
		if (difference == 0) {
			...
			if (alertHour > hours) {
				...
				if (alertMints > mints) {
					...
					$("e")
							.html(
									" <font color='red'>Alert Date must be greater than Current Date and Time</font>");
					flag = false;
				}
			} else {
				// alert("not checked")
				...
				function(isConfirm) {
					if (isConfirm) {
						...
						var reviewAlertDate = $('#reviewAlertDate').val() + " "
								+ alertHours + ":" + alertMints;
						var alertMessageTechReview = $(
								'#alertMessageTechReview').val();
						var timeZone = $('#timeZone').val();
						var interviewLocation = $('#interviewLocation').val();
						var techReviewQuestions = $('#techReviewQuestions')
								.val();
						var techReviewComments = $('#interviewComments').val();
						var techReviewSeverity = $('#techReviewSeverity').val();
						var techReviewTime = $('#techReviewTime').val() + ":"
								+ $('#techReviewMints').val();
						var skillCategoryArry = [];
						$("#skillCategoryValue :selected").each(function() {
							skillCategoryArry.push($(this).val());
						...
						if ($('#skillid0').val() != "") {
							if ($('#skill0').val() != "") {
								var skill1Questions = $('#skillid0').val()
										+ "-" + $('#skill0').val();
							}
						...
						if ($('#skillid1').val() != "") {
							...
							if ($('#skill1').val() != "") {
								var skill2Questions = $('#skillid1').val()
										+ "-" + $('#skill1').val();
							}
						...
						if ($('#skillid2').val() != "") {
							if ($('#skill2').val() != "") {
								var skill3Questions = $('#skillid2').val()
										+ "-" + $('#skill2').val();
							}
						...
						if ($('#skillid3').val() != "") {
							if ($('#skill3').val() != "") {
								var skill4Questions = $('#skillid3').val()
										+ "-" + $('#skill3').val();
							}
						...
						if ($('#skillid4').val() != "") {
							if ($('#skill4').val() != "") {
								var skill5Questions = $('#skillid4').val()
										+ "-" + $('#skill4').val();
							}
						...
						if ($('#skillid5').val() != "") {
							if ($('#skill5').val() != "") {
								var skill6Questions = $('#skillid5').val()
										+ "-" + $('#skill5').val();
							}
						...
						if ($('#skillid6').val() != "") {
							if ($('#skill6').val() != "") {
								var skill7Questions = $('#skillid6').val()
										+ "-" + $('#skill6').val();
							}
						...
						if ($('#skillid7').val() != "") {
							if ($('#skill7').val() != "") {
								var skill8Questions = $('#skillid7').val()
										+ "-" + $('#skill7').val();
							}
						...
						if ($('#skillid8').val() != "") {
							if ($('#skill8').val() != "") {
								var skill9Questions = $('#skillid8').val()
										+ "-" + $('#skill8').val();
							}
						...
						if ($('#skillid9').val() != "") {
							if ($('#skill9').val() != "") {
								var skill10Questions = $('#skillid9').val()
										+ "-" + $('#skill9').val();
							}
						...
						var url = '.././Requirements/techReviewForward.action?requirementId='
								+ requirementId
								+ '&consult_id='
								+ consult_id
								+ '&interview='
						...
						req.onreadystatechange = function() {
							if (req.readyState == 4 && req.status == 200) {
								// alert("Success")
								// $("e").html(" <font color='green'>Tech Review
								// Forwarded Succesfully</font></b>");
								// document.getElementsByTagName("e").innerHTML="<font
								// color='green'>Tech Review Forwarded
								// Succesfully</font></b>";
...
function getSearchTechReviewList(element) {
	...
	var interviewType = $('#interviewTypes').val();
	var interviewNotificationStatus = $('#interviewNotificationStatus').val();
	...
	if (reviewStartDate != '') {
		if (reviewEndDate == '') {
			...
			$('#techReviewValidation').html(
					" <font color='red'>Please enter end date</font>");
	...
	if (reviewStartDate != '' && reviewEndDate != '') {
		...
		var reqAddStartDate = new Date(splitReqStartDate[2],
				splitReqStartDate[0] - 1, splitReqStartDate[1]); // Y M
		// D
		var splitReqEndDate = reviewEndDate.split('-');
		var reqAddtargetDate = new Date(splitReqEndDate[2],
				splitReqEndDate[0] - 1, splitReqEndDate[1]); // Y M
		// D
		...
		if (difference < 0) {
			...
			$('#techReviewValidation')
					.html(
							" <font color='red'>Start date Must be less than End date</font>");
	...
	var url = '.././Requirements/getSearchTechReviewList.action?reviewStartDate='
			+ reviewStartDate
			+ '&techReviewStatus='
			+ techReviewStatus
			+ '&reviewEndDate='
			...
			+ interviewNotificationStatus+'&pgFlag='+pGflag+'&pgNo='+pgNo+'&recordPage='+recordPage;
	var req = initRequest(url);
	req.onreadystatechange = function() {
		...
		if (req.readyState == 4 && req.status == 200) {
			...
			populateTechReviewTable(req.responseText,element);
		}
	};
	req.open("GET", url, "true");
...
function populateTechReviewTable(response,flag) {
	//alert(response);
	/*$(".page_option").css('display', 'block');
	$(".pagination").css('display', 'block');
	*/var dataArray = response.split("###");
	var techReviewList = dataArray[0].split("^");
	...
	if(flag=='1'){
	          ...
	          document.getElementById("techReviewTotalRecords").value=dataArray[1];
	      }
	    
	 if ((document.getElementById("techReviewTotalRecords").value) > 0) {
		...
		for (var i = 0; i < techReviewList.length - 1; i++) {
			{
				...
				var row = $("<tr />")
				$("#techReviewTable").append(row); // this will append tr
				...
				row
						.append($('<td><a href=../../Requirements/requirementedit.action?customerFlag=customer&accountFlag=techReviews&jdId='
								+ Values[16]
								+ '&accountSearchID='
								+ Values[17]
								+ '&requirementId='
								...
								+ Values[16] + "</a></td>"));
				// row.append($('<td><a
				// href=../consultant/getConsultantDetails.action?techReviewFlag=techReview&consultFlag='+consultFlag+'&consult_id='+Values[0]+'&vendorcomments='+v_comments+'&requirementId='+Values[9]+'>'
				// + Values[1] + "</a></td>"));
				row
						.append($('<td><a href=../consultantLogin/getConsultantProfile.action?consultFlag='
								+ consultFlag
								+ '&accountFlag='
								+ Values[18]
								+ '&consult_id='
								...
								+ '&requirementId='
								+ Values[9]
								+ '&customerFlag=customer&pageFlag=techReviewList>'
								+ Values[1] + "</a></td>"));
				...
				if (Values[18] == 16) {
					...
					row
							.append($('<td><a href="#" class="Forwarded_popup_open" onclick="showOverlayForwardedBy('
									+ Values[7] + ');">' + Values[4] + "</td>"));
				} else
				...
				if (Values[8] == 'Rejected') {
					row
							.append($("<td><figcaption><button style='cursor: default' type='button' value="
									+ Values[6]
									+ " ><img src='./../../includes/images/download.png' height='20' width='20' style='opacity:0.3'></button></figcaption></td>"));
					if (Values[18] != 16)
						row
								.append($('<td><a href="#" class="" style="pointer-events: none; cursor: default; opacity:0.3"> Click'
										+ "</td>"));

				} else {
					row
							.append($("<td><figcaption><button type='button' value="
									+ Values[6]
									+ " onclick=doTechReviewAttachmentDownload("
									+ Values[6]
									+ ")><img src='./../../includes/images/download.png' height='20' width='20' ></button></figcaption></td>"));
					if (Values[18] != 16)
						row
								.append($('<td><a href="#" class="techReview_popup_open" onclick="techReviewOverlay('
										+ Values[9]
										+ ',\''
										+ Values[8]
										+ '\','
				...
				if (Values[18] == 11) {
					if (Values[21] == "VenPending") {

						row
								.append($("<td><a href='#' onclick='sendNotificationToConsultant("
										+ Values[11]
										+ ");'>"
										+ Values[21]
										+ "</a></td>"));
					} else if (Values[21] == "Rejected") {
						row
								.append($("<td><a href='#' data-toggle='modal' data-target='#conRejectCommentsDiv' onclick='conRejectCommentsOverlay(\""
										+ Values[23]
										+ "\")'>"
										+ Values[21]
										+ "</a></td>"));
				...
				/* else if(Values[18]==13||Values[18]==1||Values[18]==3) */
					...
					if (Values[21] == "CSRPending") {

						row
								.append($("<td><a href='#' onclick='sendNotificationToVendor("
										+ Values[11]
										+ ");'>"
										+ Values[21]
										+ "</a></td>"));
				...
				if (Values[18] == 16) {
					...
					if (Values[10] == "Online" || Values[10] == "Psychometric")
						row.append($('<td>click here</td>'));
					else {
						row.append($('<td>--</td>'));
					}

					if (Values[21] == "ConPending")
						row
								.append($("<td><a href='#' onclick='showConInterviewNotification("
										+ Values[11]
										+ ");' data-toggle='modal' data-target='#InterviewNotificationStatus_popup'>Accept/Reject</a></td>"));
					else if (Values[21] == "Accepted") {
						row.append($("<td>" + Values[21] + "</td>"));
					} else if (Values[21] == "Rejected") {
						row
								.append($("<td><a href='#' data-toggle='modal' data-target='#conRejectCommentsDiv' onclick='conRejectCommentsOverlay(\""
				...
				if (Values[18] == 3 || Values[18]==13 || Values[18]==5) {

					if (Values[21] == "Accepted") {
						row.append($("<td>" + Values[21] + "</td>"));
					} else if (Values[21] == "Rejected") {
						row
								.append($("<td><a href='#' data-toggle='modal' data-target='#conRejectCommentsDiv' onclick='conRejectCommentsOverlay(\""
		...
		row
				.append($('<td colspan="10"><font style="color: red;font-size: 15px;">No Records to display</font></td>'));
...
function doTechReviewAttachmentDownload(acc_attachment_id) {
	...
	window.location = './recruitment/consultant/downloadAttachmentTechReview.action?pageFlag='
			+ pageFlag
			+ '&acc_attachment_id='
			+ acc_attachment_id
			+ '&techSearch='
...
function techReviewOverlay(reqId, status, roleId, iNSStatus) {
	$("e").html(" ");
	...
	if (roleId == 13 || roleId == 3) {
		if (iNSStatus != "Accepted") {
			document.getElementById("saveTechReview").style.display = "none";
			$('#skillRate').removeClass('required');
			$('#CommentsDiv').removeClass('required');
		}
		else if(iNSStatus == "Accepted" && (status == "Selected" || status == "ShortListed")) {
			document.getElementById("saveTechReview").style.display = "none";
			$('#skillRate').removeClass('required');
			$('#CommentsDiv').removeClass('required');
		}
		...
		if (iNSStatus != "Accepted" && iNSStatus != "Rejected") {
			$("e")
					.html(
							"<font color='red'>Consultant has to Accept the interview.</font>");
		} else {
			$("e").html("");
		}
...
function techReviewDetailsOnOverlay(consultId, conTechId, reviewType) {
	...
	var url = '.././Requirements/getConsultDetailsOnOverlay.action?consultantId='
			+ consultId
			+ '&contechId='
			+ contechId
			+ '&req_Id='
			...
			for (var i = 0; i < techReviewList.length - 1; i++) {
				var Values = techReviewList[i].split("|");
				{
					if (reviewType != "Online" && reviewType != "Psychometric") {
						...
						if (Values[5] == "Rejected"
								|| Values[5] == "ShortListed"
								|| Values[5] == "Processing") {
						...
						if (Values[36] == 'Submitted') {
							$("#examsubmittedDate").html(
									"<font color='green'>" + Values[37]
											+ "</font>");
							if (Values[6] != 'null' && Values[7] != 0) {
								$("#skillDivQuestion1").show();
								var percentage1 = findPercentage(Values[26],
										Values[7]);
								if (percentage1 < 50) {
									$("#skillQuestion1")
											.html(
							...
							if (Values[8] != 'null' && Values[9] != 0) {
								...
								var percentage2 = findPercentage(Values[27],
										Values[9])
								if (percentage2 < 50) {
							...
							if (Values[10] != 'null' && Values[11] != 0) {
								...
								var percentage3 = findPercentage(Values[28],
										Values[11])
								if (percentage3 < 50) {
									$("#skillQuestion3")
											.html(
							...
							if (Values[12] != 'null' && Values[13] != 0) {
								...
								var percentage4 = findPercentage(Values[29],
										Values[13])
								if (percentage4 < 50) {
									$("#skillQuestion4")
											.html(
							...
							if (Values[14] != 'null' && Values[15] != 0) {
								...
								var percentage5 = findPercentage(Values[30],
										Values[15])
								if (percentage5 < 50) {
									$("#skillQuestion5")
											.html(
							...
							if (Values[16] != 'null' && Values[17] != 0) {
								...
								var percentage6 = findPercentage(Values[31],
										Values[17])
								if (percentage6 < 50) {
									$("#skillQuestion6")
											.html(
							...
							if (Values[18] != 'null' && Values[19] != 0) {
								...
								var percentage7 = findPercentage(Values[32],
										Values[19])
								if (percentage7 < 50) {
									$("#skillQuestion7")
											.html(
							...
							if (Values[20] != 'null' && Values[21] != 0) {
								...
								var percentage8 = findPercentage(Values[33],
										Values[21])
								if (percentage8 < 50) {
									$("#skillQuestion8")
											.html(
							...
							if (Values[22] != 'null' && Values[23] != 0) {
								...
								var percentage9 = findPercentage(Values[34],
										Values[23])
								if (percentage9 < 50) {
									$("#skillQuestion9")
											.html(
							...
							if (Values[24] != 'null' && Values[25] != 0) {
								...
								var percentage10 = findPercentage(Values[35],
										Values[25])
								if (percentage10 < 50) {
									$("#skillQuestion10")
											.html(
...
function saveTechReviewResults() {
	...
	if (techSkill == "") {
		$("e")
				.html(
						" <font color='red'>Technical Skills Should not be empty</font>");
		return false;
	}
	if (domainSkill == "") {
		$("e").html(
				" <font color='red'>Domain Skills Should not be empty</font>");
		return false;
	}
	if (comSkill == "") {
		$("e")
				.html(
						" <font color='red'>Communication Skills Should not be empty</font>");
		return false;
	}
	...
	var scheduleDate = new Date(interviewDate[2], interviewDate[0] - 1,
			interviewDate[1]);
	var curDate = new Date();
	if (curDate < scheduleDate) {
		return interviewDateConfirmation();
	}
	var rating = ((parseInt(techSkill, 10) + parseInt(domainSkill, 10) + parseInt(
			comSkill, 10)) / 3);
	var consultantComments = $("#consultantComments").val();
	...
	var interviewType = $("#interviewType").val();
	// alert("hi "+techSkill+" "+comSkill+" "+domainSkill+"
	// "+consultantComments+" "+finalTechReviewStatus+" "+rating+" "+techTitle+"
	// "+consultId)
	var url = '.././Requirements/saveTechReviewResults.action?techSkill='
			+ techSkill + '&domainSkill=' + domainSkill + '&comSkill='
			+ comSkill + '&rating=' + rating + '&consultantComments='
			+ consultantComments + '&finalTechReviewStatus='
			+ finalTechReviewStatus + '&techTitle=' + techTitle + '&consultId='
			+ consultId + '&requirementId=' + requirementId + '&interviewType='
			+ interviewType + '&contechId=' + contechId;
	// alert(url)
	var req = initRequest(url);
	req.onreadystatechange = function() {
		if (req.readyState == 4 && req.status == 200) {
			if (req.responseText == 1) {
				// alert(req.responseText)
				getSearchTechReviewList('1');
				$("e")
						.html(
								" <font color='green'>Tech Review Result saved Succesfully</font>");
			} else {
				...
				if (isConfirm) {
					...
					req.onreadystatechange = function() {
						if (req.readyState == 4 && req.status == 200) {
							// alert(req.responseText)
							if (req.responseText == 1) {
								// $("d").html(" <b><font color='green'>Record
								// Deleted!</font></b>");
								getSearchTechReviewList('1');
								$("e")
										.html(
												" <font color='green'>Tech Review Result saved Succesfully</font>");
								swal("Success!",
										"Tech Review saved successfully....",
										"success");
							} else {
								// $("d").html(" <b><font color='red'>Failed to
								// Delete!</font></b>");
								$("e")
										.html(
...
function searchTechReviews() {
	...
	// alert("HIIIIIIIIIIIIIIIIII "+requirementId+" "+consult_id+"
	// "+interviewDate+" "+empIdTechReview)
	var url = '.././Requirements/getConsultantTechReviews.action?requirementId='
			+ requirementId
			+ '&consult_id='
			+ consult_id
			+ '&interviewDate='
			+ interviewDate + '&empIdTechReview=' + empIdTechReview;
	var req = initRequest(url);
	req.onreadystatechange = function() {
		if (req.readyState == 4 && req.status == 200) {
			// alert(req.responseText)
	...
	if (response.length > 0) {
		...
		for (var i = 0; i < techReviewList.length - 1; i++) {
			...
			var Values = techReviewList[i].split("|");
			{
				...
				var row = $("<tr />")
				$("#techReviewSearchTable").append(row); // this will append
				// tr element to
				// table... keep its
				// reference for a
				// while since we
				...
				row
						.append($('<td><a href="#" class="techReviewResults_popup_open" onclick="techReviewResultsToViewOnOverlay(\''
								+ Values[9]
								+ '\','
								+ Values[8]
								+ ');techReviewResultsOverlay();" >'
								+ Values[9] + "</td>"));
				// row.append($('<td><a href="#"
				// class="emailPhoneShow_popup_open"
				// onclick="getMailPhoneOfReviewedBy('+Values[7]+');techReviewEmailPhoneOverlay();"
				// >'+Values[9]+"</td>"));
				...
				if (Values[3] != 'null' && Values[3] != "") {
					row
							.append($('<td><a href="#" class="emailPhoneShow_popup_open" onclick="getMailPhoneOfReviewedBy('
									+ Values[7]
									+ ');techReviewEmailPhoneOverlay();" >'
									+ Values[3] + "</td>"));
				} else {
					if (Values[9] == 'Online' || Values[9] == 'Psychometric') {
						if (Values[3] == 'null') {
				...
				// row.append($('<td><a href="#"
				// class="emailPhoneShow_popup_open"
				// onclick="getMailPhoneOfReviewedBy('+Values[10]+');techReviewEmailPhoneOverlay();"
				// >'+Values[11]+"</td>"));
				// }else{
				// Values[11]="";
				...
				if (Values[4] != 'null' && Values[4] != "") {
					row
							.append($('<td><a href="#" class="techReviewCommentsOverlay_popup_open" onclick="techReviewCommentsOverlayJs(\''
									+ Values[4]
									+ '\');" >'
									+ Values[4].substr(0, 20) + "..</td>"));
				} else {
					Values[4] = "";
					row.append($("<td>" + Values[4] + "</td>"));
				}
...
function techReviewCommentsOverlay(val) {
	var url = '.././Requirements/techReviewCommentsOverlay.action?conTechReviewId='
			+ val;
	// alert(url)
	var req = initRequest(url);
	req.onreadystatechange = function() {
...
function techReviewResultsToViewOnOverlay(reviewType, id) {
	...
	var url = '.././Requirements/getTechReviewResultOnOverlay.action?requirementId='
			+ requirementId
			+ '&consult_id='
			+ consult_id
			+ '&reviewType='
			...
			+ '&forwardedToId='
			+ forwardedToId
			+ '&conTechReviewId=' + conTechReviewId;
	var req = initRequest(url);
	req.onreadystatechange = function() {
		if (req.readyState == 4 && req.status == 200) {
			// alert(req.responseText)
...
function time() {
	var min = 0, max = 23, select = document.getElementById('techReviewTime');
...
function getQuestionsCount() {
	...
	var url = '.././Requirements/questionsCount.action?skillCategoryArry='
			+ skillCategoryArry;
	var req = initRequest(url);
	req.onreadystatechange = function() {
		if (req.readyState == 4) {
...
function populateQuestionsTable(response) {
	...
	if (response.length > 0) {
		...
		for (var i = 0; i < techReviewList.length - 1; i++) {
			...
			{
				var row = $("<tr />")
				// this will append tr element to table... keep its reference
				// for a while since we will add cels into it
...
function questionOverlay() { // alert("questionOverlay"+response)
...
function skillsQuestions() {
	...
	// {
	// $("e").html(" <b><font color='red'>Please Enter the No of
	// Questions</font></b>");
	// $("e").show().delay(4000).fadeOut();
	// return false;
	// }
	// alert(skillCategoryArry)
	var url = '.././Requirements/skillsQuestions.action?skillCategoryArry='
			+ skillCategoryArry + '&techReviewSeverity=' + techReviewSeverity
			+ '&techExamType=' + examType;
	var req = initRequest(url);
	req.onreadystatechange = function() {
			...
			var Values = techReviewList[i].split("|");
			{
				...
				$("#labelSkill" + i)
						.html(
								"<font color='#56a5ec'>"
										+ Values[2]
										+ "</font>&nbsp;<font color='#ae9b9b'>Available Questions("
										+ Values[0] + ")</font>");
...
function checkQuestionsAvailble0() {
	...
	if (Number(questionsEnter) > Number(questions)) {
		...
		$("e")
				.html(
						"<font color='red' >Questions Not Existed For the skills.</font>");
		$("e").show().delay(4000).fadeOut();
		$("#skill0").val(0);
		totalQuestionscount();
	} else {
...
function totalQuestionscount() {
	...
	$("#techReviewQuestions").val(
			Number(questionsEnter0) + Number(questionsEnter1)
					+ Number(questionsEnter2) + Number(questionsEnter3)
					+ Number(questionsEnter4) + Number(questionsEnter5)
					+ Number(questionsEnter6) + Number(questionsEnter7)
					+ Number(questionsEnter8) + Number(questionsEnter9));
}
...
function saveExamResult(val, flag) {
	...
	var url = '.././Requirements/onlineExamStatusSave.action?conTechReviewId='
			+ contechId + "&examStatus=" + val + "&consult_id=" + consultantId
			+ "&requirementId=" + requirementId + "&cnslt_comments=" + comments;
	// alert(url)
	var req = initRequest(url);
	req.onreadystatechange = function() {
		if (req.readyState == 4) {
			if (req.status == 200) {
				// alert(req.responseText);
				$("e").html(
						"<font color='green'>" + req.responseText + "</font>");
				$("e").show().delay(4000).fadeOut();
...
function doOnLoadTechReviewForward() {
	...
	myCalendar.attachEvent("onClick", function setDate(date) {
			...
			if (dd == 1) {
				...
				if (mm == 0) {
					...
					if ((yyyy % 100 == 0 && yyyy % 400 == 0) || yyyy % 4 == 0) {
						Date._MD = new Array(31, 29, 31, 30, 31, 30, 31, 31,
								30, 31, 30, 31);
					} else {
		...
		document.getElementById("reviewAlertDate").value = mm + "-" + dd + "-"
				+ yyyy;
...
function formatDate(date) {
	var d = new Date(date), month = '' + (d.getMonth() + 1), day = ''
			+ d.getDate(), year = d.getFullYear(), hh = d.getHours(), mm = d
			.getMinutes();
	if (month.length < 2)
		month = '0' + month;
	if (day.length < 2)
...
function timeAlert(hours, mints) {
	...
	var min = 0, limitHH = 0, limitMM = 0, max = 23, select = document
			.getElementById('techReviewAlertHours');
...
function sendNotificationToVendor(ctId) {
	swal(
			{
				title : "Do you want forward notification to Vendor ?",
			...
			function(isConfirm) {
				if (isConfirm) {
					...
					var url = CONTENXT_PATH
							+ "/Requirements/forwardTechReviewToVendor.action?contechId="
							+ ctId + "&interviewNotificationStatus=VenPending";
					var req = initRequest(url);
					req.onreadystatechange = function() {
						if (req.readyState == 4 && req.status == 200) {
							if (req.responseText == "true") {
								//alert(req.responseText);
								swal("Success", "Notified Successfully  ",
										"success");
								location.reload();
							} else {
								swal("Cancelled", " Some thing went wrong ",
										"error");
								location.reload();
							}
...
function sendNotificationToConsultant(ctId) {
	swal(
			{
			...
			function(isConfirm) {
				if (isConfirm) {
					...
					var url = CONTENXT_PATH
							+ "/Requirements/forwardTechReviewToConsultant.action?contechId="
							+ ctId + "&interviewNotificationStatus=ConPending";
					var req = initRequest(url);
					req.onreadystatechange = function() {
						if (req.readyState == 4 && req.status == 200) {
							//alert(req.responseText);
...
function showConInterviewNotification(ctId) {

	$("#ctId").val(ctId);

}
//To show the comment box when consultant select the reject
function showOrHideConINSComments() {
	var conINSValue;
	if (document.getElementById("coninsAccept").checked == true) {
		document.getElementById("conINSRejectionComments").style.display = 'none';
		document.getElementById("conINSRejectionComments").value = '';
		conINSValue = document.getElementById("coninsAccept").value;
	} else if (document.getElementById("coninsReject").checked == true) {
		document.getElementById("conINSRejectionComments").style.display = 'block';
		conINSValue = document.getElementById("coninsReject").value;
	}
	document.getElementById("conINSValue").value = conINSValue;

}
function submitConInterviewNotificatioinStatus() {
	document.getElementById("conINSSubmit").style.display = 'none';
	var conINSValue = document.getElementById("conINSValue").value;
	if (document.getElementById("coninsAccept").checked == false
			&& document.getElementById("coninsReject").checked == false) {
		$("#INSresultMessage")
				.html(
						"<font color=red size='2px'>Please Select Interview Notification Status</font>");
		setTimeout(function() {
			$("#INSresultMessage").children().remove();
		}, 3000);
		return false;
	}
	var conRejectionComments = document
			.getElementById("conINSRejectionComments").value;
	if (document.getElementById("coninsReject").checked == true) {
		if (conRejectionComments == "") {
			$("#INSresultMessage").html(
					"<font color=red size='2px'>Please Enter Comments</font>");
			setTimeout(function() {
				$("#INSresultMessage").children().remove();
			}, 3000);
			return false;
	...
	var url = CONTENXT_PATH
			+ "/Requirements/submitConInterviewNotification.action?contechId="
			+ ctId + "&interviewNotificationStatus=" + conINSValue
			+ "&conRejectionComments=" + conRejectionComments;
	var req = initRequest(url);
	req.onreadystatechange = function() {

		$("#INSresultMessage")
				.html(
						"<span align='center'><font color='red'><i class='fa fa-spinner fa-pulse'></i>&nbsp;&nbsp;Loading...<font></span>");
		if (req.readyState == 4 && req.status == 200) {
			...
			if (req.responseText == "true") {
				...
				$("#INSresultMessage")
						.html(
								"<font color=green size='2px'>Interview Notification submitted successfully..</font>");
				setTimeout(function() {
					$("#INSresultMessage").children().remove();
				}, 3000);
				return false;
				...
				$("#INSresultMessage")
						.html(
								"<font color=red size='2px'>Interview Notification Status not submitted.. some thing went wrong</font>");
				setTimeout(function() {
					$("#INSresultMessage").children().remove();
				}, 3000);
				return false;
...
function conRejectCommentsOverlay(comments) {
	$('#conRejComments').text('');
	$('#conRejComments').text(comments);
}
function INSOverlayClose() {
	$('input[name="conins"]').attr('checked', false);
	document.getElementById("conINSRejectionComments").value = "";
	if ($("#conINSSubmit").css('display') == 'none') {
		document.getElementById("conINSSubmit").style.display = 'block';
	}
