													...
													<div class="panel " style="margin-bottom: -8px">
														<div class="panel-body" id="panel-task-body">
															<div class="col-sm-12"
																...
																%>
																<s:hidden name="tierFlag" id="tierFlag"></s:hidden>
																<%-- <s:property value="%{tierFlag}"/> --%>
																<s:if test='%{tierFlag=="vassociation"}'>
																<s:url var="redirectUrl"
									                                action="doGetVendorList.action">
								                                </s:url>
																...
																<s:if
																	...
																	<s:url var="redirectUrl"
									                                action="searchAccountsBy.action">
								                                </s:url>
																...
																<span class="pull-right"><s:a href='%{#redirectUrl}'>
																	...
																	<s:form action="ajaxAccountUpdate"
																		...
																		<div class="panel-body" id="task-panel">
																			...
																			<s:if test="%{userType=='vendor'}">
                           														...
                           														<div class="col-sm-4">
                           														<div class="">
																					<label class="labelStyle2">Security Deposit </label>
																				</div>																	
																				<div class=" ">				
																				 <s:checkbox name="accountDetails.securityDeposit" value="%{accountDetails.securityDeposit}"  /> 																			
																				</div>
																				</div>
                           														</s:else>
