	...
	function skillApprovalAjax() {
		...
		req.onreadystatechange = function() {
			if (req.readyState == 4 && req.status == 200) {
				...
				$("#resultMessage").html("<font color='green'><br>Updated successfully</font>").show().delay(3000).fadeOut();
																...
																<tr>
																	...
																	<td><s:url var="myUrl">
																		...
																		<button id="" type='button' tabindex="19"
																			class="skillApproval_popup_open add_searchButton"
																			onclick="openDialogforSkillApproval(<s:property value="empId"/>,'<s:property value="skill_name"/>','<s:property value="skill_type"/>');">GO&nbsp;&nbsp;<i class="fa fa-arrow-circle-o-right"></i></button>
																		<!-- <button id="" type='button' tabindex="19"
