											...
											<div class="row required">
												...
												<div class="col-sm-4">
													<img alt="captcha image"
														src="<s:url action='../users/general/getCaptchaImage?captchaFlag=CVReg'/>"
														id="CVReg" /> <i class="fa fa-refresh fa-2x"
														onclick="loadNewCaptcha('CVReg');"
														style="position: absolute; top: 20%; color: darkGray; cursor: pointer; margin-left: 2%"></i>
														<s:textfield name="custVenCaptchaText" type="text"
														cssClass="form-control" id="custVenCaptchaText"
														maxLength="60" placeholder="Enter Captcha here*" />
													
												</div>
											<div class="col-sm-8"></div>
											<div class="col-sm-4"><span id="cvRegRecaptchaSpan"></span></div>
