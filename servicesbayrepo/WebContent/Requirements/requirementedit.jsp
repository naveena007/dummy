...
<body style="overflow-x: hidden" oncontextmenu="return false"
	onload="doOnloadEditRequirement();showHideEndDate();">
	<div id="wrap">
		<header id="header">
			<!--header-->
																...
																<span cellspacing="30">
																	...
																	<div class="required">
																		...
																		<div class="col-sm-3">
																			<label class="labelStyle" id="labelLevelStatusReq">
																				Type
																				<a href="#" data-toggle="tooltip" data-placement="bottom" data-html="true" title="&nbsp;<b>1.</b> If Type is Contract then SOW is <br>Processed<br><b>2.</b> If Full-time then consultant <br>becomes Permanent Customer<br> Employee ">
																...
																<s:textfield cssClass="form-control"
																	...
																	<i class="fa fa-calendar"></i>
																		...
																		<div class="col-sm-3">
																			<label class="labelStyle" id="labelLevelStatusReq">
																				Status </label>
																			<s:if test='requirementVTO.RequirementStatus=="O"'>	
																			<s:select name="RequirementStatus"
																				id="RequirementStatus"
																				value="%{requirementVTO.RequirementStatus}"
																				list="#@java.util.LinkedHashMap@{'O':'Open','R':'Released','I':'Inprogess','F':'Forecast','H':'Hold','W':'Withdrawn','S':'Won','L':'Lost','C':'Closed'}"
																				headerKey="DF"
																				cssClass="SelectBoxStyles form-control"
																				onfocus="removeErrorMessages()" />
																				</s:if>
																				<s:elseif test='requirementVTO.RequirementStatus=="R"'>
																				<s:select name="RequirementStatus"
																				id="RequirementStatus"
																				value="%{requirementVTO.RequirementStatus}"
																				list="#@java.util.LinkedHashMap@{'R':'Released','I':'Inprogess','F':'Forecast','H':'Hold','W':'Withdrawn','S':'Won','L':'Lost','C':'Closed'}"
																				headerKey="DF"
																				cssClass="SelectBoxStyles form-control"
																				onfocus="removeErrorMessages()" />
																			</s:elseif>
																			<s:elseif test='requirementVTO.RequirementStatus=="OR"'>
																			<s:select name="RequirementStatus"
																				id="RequirementStatus"
																				value="%{requirementVTO.RequirementStatus}"
																				list="#@java.util.LinkedHashMap@{'OR':'Open for Resume','I':'Inprogess','F':'Forecast','H':'Hold','W':'Withdrawn','S':'Won','L':'Lost','C':'Closed'}"
																				headerKey="DF"
																				cssClass="SelectBoxStyles form-control"
																				onfocus="removeErrorMessages()" />
																			</s:elseif>
																			...
																			<s:select name="RequirementStatus"
																				id="RequirementStatus"
																				value="%{requirementVTO.RequirementStatus}"
																				list="#@java.util.LinkedHashMap@{'O':'Open','R':'Released','OR':'Open for Resume','I':'Inprogess','F':'Forecast','H':'Hold','W':'Withdrawn','S':'Won','L':'Lost','C':'Closed'}"
																				headerKey="DF"
																				cssClass="SelectBoxStyles form-control"
																				onfocus="removeErrorMessages()" />
																			</s:else>
																			...
																			<div id="downloading_grid"
																				...
																				<div class="pull-right  req_btn col-sm-0"
																					...
																					<div onclick="downloadPDFSubmittedList()"
																						...
																						class="fa fa-download cssbutton form-control" style="cursor: pointer;">&nbsp;DownloadPDF</div>
																				</div>
																				<div class="pull-right  req_btn col-sm-0">
																					<div onclick="downloadXLSSubmittedList()"
																						id="submittedListDownloadXLSButton" tabindex="9"
																						class=" fa fa-download cssbutton form-control" style="cursor: pointer;">&nbsp;DownloadXLS</div>
																				</div>
																			</div>
																		</div>
																		</div>
