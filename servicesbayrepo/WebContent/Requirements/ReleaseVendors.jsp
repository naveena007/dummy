...
<title>ServicesBay :: Release Requirements</title>
...
<body style="overflow-x: hidden" oncontextmenu="return false"
	onload="getReleaseVendorsListForCsr();">
	<div id="wrap">
		<header id="header">
			<!--header-->
		...
		<%
			String currentOrgId = session.getAttribute(ApplicationConstants.ORG_ID).toString();
		%>
		<%-- <div class="backgroundcolor">
			<s:url var="myUrl"
				...
				<s:param name="orgid"><%=currentOrgId%></s:param>
			</s:url>
							...
							<div class="features_items">
								<div class="col-lg-14 ">
									<div class="" id="profileBox"
										...
										<div class="backgroundcolor">
											<div class="panel-heading">
												<h4 class="panel-title">
													...
													<font color="#ffffff">Release Vendor</font> 
													<s:url var="myUrl"
				                                      action="recruitment/consultant/getLoginUserRequirementList.action">
				                                      <s:param name="accountFlag">MyRequirements</s:param>
				                                      <s:param name="customerFlag">customer</s:param>
			                                       ...
			                                       <span class="pull-right"><s:a href='%{#myUrl}'>
													...
													&nbsp;&nbsp;
													<i id="updownArrow"
														onclick="toggleContent('showReleaseVendorDetails')"
														class="fa fa-minus"></i>
										...
										<div class="col-sm-13" id="showReleaseVendorDetails">
											...
											<input type="hidden" id="vendorsIdString"
												name="vendorsIdString" />
											<s:hidden name="taxTerm" id="taxTerm" value="%{taxTerm}" />

											<div class="inner-reqdiv-elements">
												<div class="col-sm-12">
													<div class="col-sm-3">
														<label class=""> Account Name :</label> <span
													...
													<div class="col-sm-3 pull-right">
														<label class=""> Job Id :</label> <span
															style="color: #FF8A14;">JD-<s:property
																value="%{requirementId}" /></span>
													</div>
												</div>
												<div class="col-sm-12"></div>
												...
												<div class="">
													<div class="col-sm-4">
														<label class="labelStylereq" style="color: #56a5ec;">Vendor
															Name</label>
														<s:textfield id="vendorName" cssClass="form-control"
															name="vendorName" placeholder="Vendor Name" tabindex="1"
															maxLength="60" />
													</div>

													<div class="col-sm-4">
														<label class="labelStylereq" style="color: #56a5ec;">Tier
															 </label>
														<s:select id="tier" name="tier" label="Tier"
															cssClass="SelectBoxStyles form-control" headerKey="-1"
															headerValue="All" theme="simple"
															list="#@java.util.LinkedHashMap@{1:'Tier-1',2:'Tier-2',3:'Tier-3'}"
															tabindex="1" />
													</div>

													<div class="col-sm-2">
														<label class="labelStylereq" style=""></label> <input
															type="button" class="add_searchButton form-control "
															id="searchButton" value="Search" tabindex="3"
															style="margin: 6px 0px;"
															onclick="getReleaseVendorsListForCsr()" />
										...
										<s:form>
											<div class="emp_Content" id="emp_div" align="center"
												style="display: none">
												<table id="releaseReqTable"
													class="responsive CSSTable_task " border="5"
													cell-spacing="2" style="margin-top: 13px;">
													<tbody>
														<tr>
															<th>VendorName</th>
															<th>Tier</th>
										...
										<div class="col-sm-12">
											...
											<div class="col-sm-2">
												...
												<br>
													<s:checkbox cssClass="checkboxAlign" name="allVendors"
														id="allVendors" onclick="onClickHandlerForCSR(this)" />
													&nbsp;<span style="font-size:18px">Release All
													<a data-toggle="modal" data-placement="top"
													title="Relase Requirements" data-target="#myModal"> <img
													src="/sb/includes/images/icons/isymbol.png" width="19"
													height="21" style="cursor: pointer;"/>
												</a></span>
												</div>
											</div>
											...
											<div class="col-sm-2">
												...
												<button class="cssbutton" style="display: none;"
													onclick="doReleaseRequirementForCSR()"
													id="vendorReleaseButton">
													<span class=" fa fa-arrow-circle-o-right pull-left"></span>&nbsp;Release
												</button>
					...
					<div class="modal-body">
						<div class="main-login-form">
							<div class="login-group">
								...
								<p>
									* <b>Tier-1 Associated Vendors</b> : If the requirement is <b>Contract</b>
									then initially requirement will be released to Tier-1 Vendors.
								</p>
								<p>
									* <b>HeadHunters</b> : If the requirement is <b>Fulltime</b>
									then initially requirement will be released to HeadHunters
								</p>
								<p>
									* <b>All Vendors </b>: Select All Vendors to release this
									requirement to every vendor associated with this Customer.
								</p>
...
<%-- 	<script type="text/javascript">
		...
		function pagerOption() {
			...
			recordPage = paginationSize;
			//alert(recordPage)
			$('#timesheet_results').tablePaginate({
				navigateType : 'navigator'
			}, recordPage);
