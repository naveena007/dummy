...
public class SbRun extends Extents {
	...
	public static void main(String[] args)  {
		...
		new SbRun().testing();
			...
			System.out.println("Exception in main testing-->"+e.getMessage());
		}
	}
	...
	/*	Properties adminProp = rp.getSiteAdminObjectPath();
		...
		*/
		...
		properties2.load(new FileInputStream(new File("C:\\Users\\miracle1\\.jenkins\\workspace\\MsbDev2\\sbTestKDF\\src\\com\\mss\\sb\\resources\\AllExcelSheets.properties")));
		...
		//	send.mail(folder);
			...
			try 
			{
				...
				Set passOrFailSet=GettingData.getPassOrFailResult();
				System.out.println("passOrFailSet--->"+passOrFailSet.toString());
															// excel
					if(passOrFailSet.contains("Fail")){
					...
					/*if(resultType.equals("Pass"))														// sheet
                 System.exit(0);	
				 else
				System.exit(-1); */		 
			  } 
