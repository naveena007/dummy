...
public class RequirementAction extends ActionSupport implements ServletRequestAware, ServletResponseAware {
	...
	private String profileSubmissionCost;
	private String profileSelectedCost;
	private String profileRejectionCost;
	private String fakeCandidateFine;
	private String comments;
	private String securityDepositCheck;

	public String getSecurityDepositCheck() {
		return securityDepositCheck;
	}

	public void setSecurityDepositCheck(String securityDepositCheck) {
		this.securityDepositCheck = securityDepositCheck;
	}

	public String getProfileSubmissionCost() {
		return profileSubmissionCost;
	}

	public void setProfileSubmissionCost(String profileSubmissionCost) {
		this.profileSubmissionCost = profileSubmissionCost;
	}

	public String getProfileSelectedCost() {
		return profileSelectedCost;
	}

	public void setProfileSelectedCost(String profileSelectedCost) {
		this.profileSelectedCost = profileSelectedCost;
	}

	public String getProfileRejectionCost() {
		return profileRejectionCost;
	}

	public void setProfileRejectionCost(String profileRejectionCost) {
		this.profileRejectionCost = profileRejectionCost;
	}

	public String getFakeCandidateFine() {
		return fakeCandidateFine;
	}

	public void setFakeCandidateFine(String fakeCandidateFine) {
		this.fakeCandidateFine = fakeCandidateFine;
	}
	...
	public String addRequirements() {
		...
		try {
			if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
				 ...
				 * + entry.getValue()); if((entry.getValue()).equals("Others")){
				 * continue; } tempMap.put(entry.getKey(),entry.getValue());
				 * 
				 * }
				 * 
				 ...
				 * System.out.println("After Sorting:"); Set set2 =
				 * map.entrySet(); Iterator iterator2 = set2.iterator();
				 * while(iterator2.hasNext()) { Map.Entry me2 =
				 * (Map.Entry)iterator2.next(); System.out.print(me2.getKey() +
	...
	/*
	 * private static HashMap sortByValues(Map tempMap) { List list = new
	 * LinkedList(tempMap.entrySet()); // Defined Custom Comparator here
		...
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
				int userid = Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString());
				int org_id = Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.ORG_ID).toString());
				String typeOfUser = httpServletRequest.getSession(false).getAttribute(ApplicationConstants.TYPE_OF_USER)
						.toString();
	...
	public String updateRequirements() {
		...
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
				...
				if (updated > 0) {
					if ((!"OR".equalsIgnoreCase(getStatus_check()))
							&& ("OR".equalsIgnoreCase(getRequirementStatus()))) {
						setMailIds(
								DataSourceDataProvider.getInstance().getMailIdsOfVendorAssociated(getRequirementId()));
	...
	public String getReqDetailsBySearch() {
		resultMessage = LOGIN;
		System.out.println(
				"********************RequirementAction :: getReqDetailsBySearch Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
		...
		System.out.println(
				"********************RequirementAction :: getReqDetailsBySearch Method End*********************");
		return null;
	}
	...
	public String getSkillDetaisls() {
		resultMessage = LOGIN;
		System.out
				.println("********************RequirementAction :: getSkillDetaisls Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
				setUserSessionId(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
		...
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
				...
				if (getFileFileName() == null) {
					...
					createPath = new File(createPath.getAbsolutePath() + "/" + String.valueOf(dt.getYear() + 1900) + "/"
							+ month + "/" + String.valueOf(week));
	...
	public String getSearchRequirementsList() {
		resultMessage = LOGIN;
		System.out.println(
				"********************RequirementAction :: getSearchRequirementsList Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {

				setPrimaryRole(Integer.parseInt(httpServletRequest.getSession(false)
				...
				Map skillsmap = (Map) session.get("skillsmap");
				String list = ServiceLocator.getRequirementService().getSearchRequirementsList(httpServletRequest, this,
						skillsmap);
				httpServletResponse.setHeader("Cache-Control", "no-cache, no-store, must-revalidate");
				httpServletResponse.setHeader("Pragma", "no-cache");
				httpServletResponse.setDateHeader("Expires", 0);
		...
		System.out.println(
				"********************RequirementAction :: getSearchRequirementsList Method End*********************");
		return null;
	}
	...
	public String getRecruiterOverlay() {
		resultMessage = LOGIN;
		System.out.println(
				"********************RequirementAction :: getRecruiterOverlay Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
		...
		System.out.println(
				"********************RequirementAction :: getRecruiterOverlay Method End*********************");
		return null;
	}
	...
	public String getSkillOverlay() {
		resultMessage = LOGIN;
		System.out
				.println("********************RequirementAction :: getSkillOverlay Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
	...
	public String getPreSkillOverlay() {
		resultMessage = LOGIN;
		System.out.println(
				"********************RequirementAction :: getPreSkillOverlay Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
		...
		System.out
				.println("********************RequirementAction :: getPreSkillOverlay Method End*********************");
		return null;
	}
		...
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
				setUserSessionId(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
				/*
				 * setSessionOrgId(Integer.parseInt(httpServletRequest.
				 * getSession(false).getAttribute(ApplicationConstants.ORG_ID).
				 * toString()));
				 */
	...
	public String getVendorsBasedOnReqCategory() {
		...
		String resultString = "";
		log.info(
				"********************RequirementAction :: getVendorsBasedOnReqCategory Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
				setUserSessionId(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
				...
				resultString = dataSourceDataProvider.getInstance().getVendorsBasedOnReqCategory(getRequirementId(),
						getOrgId(), getTaxTerm(), getVendorName(), getVendorTierType());
				httpServletResponse.setHeader("Cache-Control", "no-cache, no-store, must-revalidate");
				httpServletResponse.setHeader("Pragma", "no-cache");
				httpServletResponse.setDateHeader("Expires", 0);
				httpServletResponse.setContentType("text");
		...
		log.info(
				"********************RequirementAction :: getVendorsBasedOnReqCategory Method End*********************");
		return null;
	}

	public String SendReqNotificationToCSR() {
		resultMessage = LOGIN;
		System.out.println(
				"********************RequirementAction :: SendReqNotificationToCSR Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
				setUserSessionId(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
				String response = ServiceLocator.getRequirementService().SendReqNotificationToCSR(httpServletRequest,
						this);
				httpServletResponse.setHeader("Cache-Control", "no-cache, no-store, must-revalidate");
				httpServletResponse.setHeader("Pragma", "no-cache");
				httpServletResponse.setDateHeader("Expires", 0);
	...
	public String getRequirementDashBoardDetails() {
		resultMessage = LOGIN;
		System.out.println(
				"********************RequirementAction :: getRequirementDashBoardDetails Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
				setUserSessionId(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
				setTypeOfUser(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.TYPE_OF_USER)
						.toString());
		...
		System.out.println(
				"********************RequirementAction :: getRequirementDashBoardDetails Method End*********************");
		return null;
	}
	...
	public String getRequirementDashBoardDetailsOnOverlay() {
		resultMessage = LOGIN;
		System.out.println(
				"********************RequirementAction :: getRequirementDashBoardDetailsOnOverlay Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
				setUserSessionId(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
		...
		System.out.println(
				"********************RequirementAction :: getRequirementDashBoardDetailsOnOverlay Method End*********************");
		return null;
	}
	...
	public String getVendorRequirementDashBoardDetails() {
		resultMessage = LOGIN;
		System.out.println(
				"********************RequirementAction :: getVendorRequirementDashBoardDetails Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
				setUserSessionId(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
		...
		System.out.println(
				"********************RequirementAction :: getVendorRequirementDashBoardDetails Method End*********************");
		return null;
	}
	...
	public String getVendorRequirementsDashBoard() {
		resultMessage = LOGIN;
		System.out.println(
				"********************RequirementAction :: getVendorRequirementsDashBoard Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
				setUserSessionId(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
		...
		System.out.println(
				"********************RequirementAction :: getVendorRequirementsDashBoard Method End*********************");
		return null;
	}
	...
	public String getVendorDashBoardDetailsOnOverlay() {
		resultMessage = LOGIN;
		System.out.println(
				"********************RequirementAction :: getVendorDashBoardDetailsOnOverlay Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
		...
		System.out.println(
				"********************RequirementAction :: getVendorDashBoardDetailsOnOverlay Method End*********************");
		return null;
	}
	...
	public String customerDashBoardDetails() throws ServiceLocatorException {
		...
		System.out.println(
				"********************RequirementAction :: customerDashBoardDetails Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			...
			setSessionOrgId(Integer.parseInt(
					httpServletRequest.getSession(false).getAttribute(ApplicationConstants.ORG_ID).toString()));
			customerDashBoardList = (ServiceLocator.getRequirementService()
					.getDefaultCustomerRequirementDashBoardDetails(this));

			setYear(Calendar.getInstance().get(Calendar.YEAR));
			resulttype = SUCCESS;
		}
		System.out.println(
				"********************RequirementAction :: customerDashBoardDetails Method End*********************");
		return resulttype;
	}
	...
	public String getCustomerRequirementDashBoardDetails() {
		resultMessage = LOGIN;
		System.out.println(
				"********************RequirementAction :: getCustomerRequirementDashBoardDetails Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
				setUserSessionId(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
		...
		System.out.println(
				"********************RequirementAction :: getCustomerRequirementDashBoardDetails Method End*********************");
		return null;
	}
	...
	public String getPreferedSkillDetails() {
		resultMessage = LOGIN;
		System.out.println(
				"********************RequirementAction :: getPreferedSkillDetails Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
				setUserSessionId(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
		...
		System.out.println(
				"********************RequirementAction :: getPreferedSkillDetails Method End*********************");
		return null;
	}
	...
	public String getCustomerRequirementPieChartDetails() {
		resultMessage = LOGIN;
		System.out.println(
				"********************RequirementAction :: getCustomerRequirementPieChartDetails Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
				setUserSessionId(Integer.parseInt(
						httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
