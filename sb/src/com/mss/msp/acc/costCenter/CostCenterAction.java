...
public class CostCenterAction extends ActionSupport implements ServletRequestAware, ServletResponseAware {
	...
	public String costCenterBySearch() {
		resultType = LOGIN;
		System.out.println(
				"********************CostCenterAction :: costCenterBySearch Method Start*********************");
		if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
			try {
				...
				String list = ServiceLocator.getCostCenterService().costCenterBySearch(this, orgId);
		...
		System.out.println(
				"********************CostCenterAction :: costCenterBySearch Method End*********************");
		return null;
	}
