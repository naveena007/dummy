                ...
                <div id="utilitiesMenuCustAdmin" class="panel-collapse collapse">
                    <div class="panel-body">
                        <ul id="utilitiesDisplay">
                            ...
                            <li><a id="securityDepositUtilitiesCustAdmin" href="/<%=ApplicationConstants.CONTEXT_PATH%>/Requirements/getSecurityDepositList.action" onClick="leftMenuToggleId(this,'utilitiesAdmin');"><i class="fa fa-lock" aria-hidden="true"></i>&nbsp;Security&nbsp;Deposit</a></li>
                            <li><a id="securityDepositAmountsUtilitiesCustAdmin" href="/<%=ApplicationConstants.CONTEXT_PATH%>/Requirements/getSecurityDepositAmountsList.action" onClick="leftMenuToggleId(this,'utilitiesAdmin');"><i class="fa fa-money" aria-hidden="true"></i>&nbsp;Security&nbsp;Deposit&nbsp;Amts</a></li>
