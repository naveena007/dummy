                                            ...
                                            <div class="backgroundcolor" >
                                                ...
                                                <s:form action="searchLoggerForQues" theme="simple" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="col-sm-3">
                                                        ...
                                                        <div class="calImage">
                                                        <s:textfield tabindex="1" cssClass="form-control" name="createdDate" id="created_Date" placeholder="Created Date" value="" onkeypress="return enterDateRepository();"><i class="fa fa-calendar"></i></s:textfield>
                                                        </div>
                                                        </div>
                                                        <div class="col-sm-3">
