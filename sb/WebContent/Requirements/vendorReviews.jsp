                                                    ...
                                                    <div class="panel-body" >
                                                        ...
                                                        <div>
                                                            <div class="col-sm-2 pull-right">
                                                                <button id="commentbutton"  style="margin:13px 0px;" class="add_searchButton form-control" onclick="return addVendorRatingAndReveiw()" ><i class="fa fa-floppy-o" aria-hidden="true"></i>&nbsp;Save&nbsp;Comment</button>
                                                            </div>
                                                        </div>
