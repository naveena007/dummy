...
<body style="overflow-x: hidden" oncontextmenu="return false"
	onload="showHideEndDate();doOnLoadRequirement();" ng-app="myApp1" >
	<div id="wrap" ng-controller="reqAddCtrl">
			<header id="header">
			<!--header-->
												...
												<span cellspacing="30"> <span><editrequirementerror></editrequirementerror></span>
													...
													<div>
														...
														<%-- <div class="col-sm-3 required" id="">
                                                            ...
                                                            <div id="loadingConsultant" class="loadingImg" style="display: none">
														...
														<div class="col-sm-3 required" id="">
															<label class="labelStyle" id="labelLevelStatusReq">
																Title 
																<a href="#" data-toggle="tooltip" data-container="body" data-placement="right" data-html="true" title="<font align='left'><b>1.</b> If Title is Selected from suggestion List then <br>Max Rate and Min Rate is populated as created in Ratecard<br><b>2.</b> If new Title is added then user can specify Max Rate and Min Rate.</font>">
															   <img src="/sb/includes/images/icons/isymbol.png" width="15" height="15"/>
															</a></label>
															<s:textfield cssClass="form-control" id="RequirementName"
																type="text" 
																placeholder="Title" 
																maxLength="50" ng-keyup="getRateCardsList()" onfocus="removeErrorMessages()"
																ng-model="RequirementName.searchKey" ng-init="RequirementName.searchKey='%{requirementVTO.RequirementName}'" />

															<div class="col-sm-10 selectivity_block" style="border: 1px dashed gray;" autocomplete='off'>

															 <div class="suggestionList1">
															 	<div ng-repeat="rateCard in rateCards" >
																		<a ng-click="selectRatecard(rateCard)" style="cursor:pointer" class="suggestionList">{{rateCard.jobTitle}}
																		</a>
																	</div>
																</div> 
															</div>
														...
														<div class="col-sm-3 required" id="">
															<label class="labelStyle" id="labelLevelStatusReq">Work Center Location
															</label>
 ...
 --%>
														...
														<div class="col-sm-3 required" id="">
															<label class="labelStyle" id="labelLevelStatusReq">
																Type 
																<a href="#" data-toggle="tooltip" data-placement="top" data-html="true" title="&nbsp;&nbsp;&nbsp;<b>1.</b> If Type is Contract then SOW is <br>Processed<br><b>2.</b> If Full-time then consultant <br>becomes Permanent Customer <br>Employee ">
															   <img src="/sb/includes/images/icons/isymbol.png" width="15" height="15"/>
															</a></label>
														...
														<div class="col-sm-3 required" id="">
															<label class="labelStyle" id="labelLevelStatusReq">Desired Start Date
															</label>
															<div class="calImage">
																<s:textfield cssClass="form-control"
														...
														<div class="col-sm-3 required" id="endDateDiv" style="display: none;">
															<label class="labelStyle" id="labelLevelStatusReq">Expected End Date
															</label>
															<div class="calImage">
																<s:textfield cssClass="form-control"
																	id="RequirementEnd" placeholder="End Date"
														...
														<div class="col-sm-6 ">
															<span class="required"> <s:if
																	...
																	<s:select cssClass="" name="skillCategoryValue"
																		id="skillCategoryValue" list="skillSetValuesMap" multiple="true"
																		onfocus="removeErrorMessages()" />
																</s:if> <s:else>
																	<label class="labelStyle skills"
																		id="labelLevelStatusReq">Skill&nbsp;Set </label>
