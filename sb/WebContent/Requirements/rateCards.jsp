    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function sortables_init() {
                ...
                tbls = document.getElementById("rateCardResults");
                sortableTableRows = document.getElementById("rateCardResults").rows;
                sortableTableName = "rateCardResults";
    ...
    <body oncontextmenu="return false" style="overflow-x: hidden">
            ...
            <div id="main">
                <section id="generalForm">
                    ...
                    <div id="addAuthAccOverlay_popup" >
                        <div id="addAuthAccBox" style="width:500px">
                            <div class="backgroundcolor">
                                <table>
                            ...
                            <s:hidden id="overlayRatecardId" name="overlayRatecardId"/>
                              <%--   <s:hidden id="overlayActionId" value="overlayActionId"/>
                                ...
                                <s:hidden id="titleCount" name="titleCount"/>
        ...
        <script type="text/javascript">
            ...
            function pagerOption(){
                ...
                $('#rateCardResults').tablePaginate({navigateType:'navigator'},recordPage);
            };
            $('#rateCardResults').tablePaginate({navigateType:'navigator'},recordPage);
        </script>
