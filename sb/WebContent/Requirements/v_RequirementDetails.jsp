...
<body style="overflow-x: hidden" oncontextmenu="return false"
									...
									<div class=" panel-info">
										<div class="panel-body" id="panel-task-body">
											...
											<ul class="nav nav-tabs">
												<s:if test="vendor=='yes' || #session.primaryrole == 16 || #session.primaryrole == 11">
												...
												<s:if test="vendor!='yes'">
													<s:if test="#session.primaryrole == 16 || #session.primaryrole == 11">
 ...
 --%>
												...
												<s:elseif test="accountFlag=='MyRequirements' && pageFlag!='techReviewList'">
															...
															<div class="panel-body">
																<s:form action="#" method="post" theme="simple">
																	...
																	<div class="row">
																		...
																		<div class="col-sm-6 col-md-6 col-lg-4">
																			...
																			<label class="labelStyle" id="labelLevelStatusReq"
																				style="width: 90px"><b> Title :</b> </label><label><b
																		...
																		<div class="col-sm-6 col-md-6 col-lg-4">
																			<label class="labelStyle" id="labelLevelStatusReq"
																				style="width: 130px"><b>Desired Start&nbsp;Date
																				:</b></label><font class="ven_ReqEdit"><s:property
																		...
																		<div id="requirementEndDiv"
																			...
																			style="display: none">
																			<label class="labelStyle" id="labelLevelStatusReq"
																				style="width: 125px"><b> Expected End&nbsp;Date
																				:</b></label><font class="ven_ReqEdit"> <s:if
																		...
																		<div class="col-sm-6 col-md-6 col-lg-4">
																			<label class="labelStyle" id="labelLevelStatusReq">
																				<b>Type :</b></label><font id="requremenType" class="ven_ReqEdit"></font>
																		...
																		<div class="col-sm-6 col-md-6 col-lg-4">
																			<label class="labelStyle" id="labelLevelStatusReq"
																				style="width: 132px"><b> Number of Positions :</b></label><b
																				class="ven_ReqEdit"><s:property
																		...
																		<s:if test="requirementVTO.RequirementTaxTerm=='PE'">
																			<div class="col-sm-6 col-md-6 col-lg-4">
																				<label class="labelStyle" id="labelLevelStatusReq"
																					style="width: 150px"> Work Center Location
																		...
																		<div class="col-sm-6 col-md-6 col-lg-4">
																			<label class="labelStyle" id="labelLevelStatusReq"
																				style="width: 130px"><b> Req.Exp :</b></label><font
                                                                       ...
                                                                       <div class="col-sm-12 row">
																		<s:if test="requirementVTO.RequirementTaxTerm=='CO'">
																			<div class="col-sm-6 col-md-6 col-lg-4">
																				<label class="labelStyle" id="labelLevelStatusReq"
																					style="width: 150px"><b> Work Center Location
																					:</b></label><font id="requrementVendorLocation"
																					class="ven_ReqEdit"></font>
																				<s:select name="RequirementLocation"
																					id="RequirementLocation"
																					value="%{requirementVTO.RequirementLocation}"
																		...
																		<s:if test="requirementVTO.RequirementTaxTerm=='CO'">
																			<div class="col-sm-6 col-md-6 col-lg-4">
																				<label class="labelStyle" id="labelLevelStatusReq"
																					style="width: 130px"><b>&nbsp;&nbsp;&nbsp;Min&nbsp;Rate :</b> </label><font
																					style="color: black">$&nbsp;<s:property
																						value="%{requirementVTO.RequirementTargetRate}" />&nbsp;/Hr
																				</font>
																			</div>
																			<div class="col-sm-6 col-md-6 col-lg-4">
																				<label class="labelStyle" id="labelLevelStatusReq" style="width:150px"><b>
																					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Max&nbsp;Rate :</b></label><font style="color: black">$&nbsp;<s:property
																						value="%{requirementVTO.requirementMaxRate}" />&nbsp;/Hr
																				</font>
																			</div>
																		</s:if>
																		...
																		<div class="col-sm-6 col-md-6 col-lg-4">
																			<label class="labelStylereq "
																				style="padding-right: 57px"><b>Req.Category :</b></label><font
																	...
																	<div class="col-lg-12 row">
																		<label class="labelStyle" id="labelLevelStatusReq"><b>Description
																			:</b></label>
																	...
																	<div class="col-lg-12 row">
																		<label class="labelStyle" id="labelLevelStatusReq"><b>Responsibilities
																			:</b></label>
																		<p style="color: black" align="justify">
																			<s:property
																	...
																	<div class="col-lg-12 row">
																		<label class="labelStyle" style="width: 140px"
																			id="labelLevelStatusReq"><b>Qualification :</b></label><font
																			style="color: black"><s:property
																	...
																	<div class="col-sm-12">
																		<div class="row">
																			...
																			<span class=""> <label class="labelStyle"
																				id="labelLevelStatusReq" style="margin-right: 70px"><b>Skill&nbsp;Set
																					:</b></label><font id="requrementSkills" style="color: black"></font>
																	...
																	<div class="row">
																		<div class="col-sm-12">
																			<div id="reqvendorPrefer">
																				<label class="labelStyle" id="labelLevelStatusReq"
																					style="margin-right: 70px"><b>Preferred&nbsp;Skill&nbsp;Set
																					:</b></label><font id="requrementPreferedSkills"
																	...
																	<s:if test="requirementVTO.RequirementComments!=''">
																		<div class="col-lg-12 row">
																			<label class="labelStyle" id="labelLevelStatusReq"><b>Comments
																				:</b></label>
																			<p style="color: black" align="justify">
																				<s:property
														...
														<div class="col-sm-12" id="consultantSearchForm">
															<s:form action="" theme="simple"
																...
																<div class="row">
                                                                    ...
                                                                    <s:if test="#session['usrgrpid']==1 || #session.primaryrole == 1">									                                    <div class="col-sm-3">
										                                   <label class="labelStylereq" style="color: #56a5ec;">
											                                        CSR Status </label>
																			...
																			<table id="consultantListTable"
																				...
																				<tbody>
																					<tr>
                                                                                        ...
                                                                                        <s:if test="#session['usrgrpid'] == 1 || #session.primaryrole == 1">							
																							<th>CSR Status</th>
																						</s:if>
																						<th>Proceed</th>
																						<s:if test="vendor=='yes'">
