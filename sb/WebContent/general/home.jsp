...
<script>
function simpCaptchaValidation(id,flag,span)
{
...
//alert(captchaValue);
result=simpleCaptchaValidation(captchaValue,flag);
//alert(result);
if(result===false)
{
	...
	loadNewCaptcha(flag);
	$("#"+id).val("");
$("#"+span).html("<font color='red' size='2' face='Sans Serif'>Invalid captcha..</font>");
 setTimeout(function() {
...
<body oncontextmenu="return false"
	onload="disableBack();loadNewCaptcha(document.getElementById('captchaFlag').value);">
...
<img data-u="thumb" src="<%=request.getContextPath()%>/includes/js/homeslider/img/slide-Copy.png" />
							...
							<s:hidden name="captchaFlag" id="captchaFlag" />
									...
									<div
										...
										<center>
											<s:form id="forgotPassword" name="forgotPassword">
												...
												<!-- simple captcha for  Customer/Vendor Forgot password start-->

												<div
													style="background-color: whitesmoke; border-radius: 9px;">
													<%-- src="<s:url action='../users/general/getCaptchaImage?captchaFlag=CVFPCaptcha'/>" --%>
													<img alt="captcha image" id="CVFPCaptcha" /> <i
														class="fa fa-refresh fa-2x"
														onclick="loadNewCaptcha('CVFPCaptcha');"
														style="color: darkGray; cursor: pointer;position:absolute;margin-top:4%"></i>
												</div>
												<br>
												<div class="logCredential">
													<input type="text" name="CVFPCaptchaText" type="text"
														id="CVFPCaptchaText" maxLength="50"
														placeholder="Enter Captcha here*" class="frgt_pwd"
														required="required" /> <span id="CVFPCaptchaSpan"></span>
												</div>

												<!-- simple captcha for Customer/Vendor Forgot password end -->
								...
								<div id="forgetoverlay">
									...
									<div
										...
										<span id="conFPLoading"
											style="color: red; width: auto; display: none">Loading....</span>
										<span id="conFPResultMessage"></span>
										<center>
											<s:form id="forgotPassword" name="forgotPassword">
												<div class="logCredential">
													<i class="fa fa-envelope"></i> <input type="email"
												...
												<!-- Google recpatcha for consultant forgot password -->
												<%-- <div id="conForgotPasswordReCaptcha"></div>
												<div>
													<span id="conForgotPasswordReCaptchaSpan"></span>
												</div> --%>

												<!-- simple captcha for consultant forgot password login start -->
												<div
													style="background-color: whitesmoke; border-radius: 9px;">
													<%-- src="<s:url action='../users/general/getCaptchaImage?captchaFlag=conFPCaptcha'/>" --%>
													<img alt="captcha image" id="conFPCaptcha" style="" /> <i
														class="fa fa-refresh fa-2x"
														onclick="loadNewCaptcha('conFPCaptcha');"
														style="color: darkGray; cursor: pointer;position:absolute;margin-top:4%"></i>
												</div>
												<br>
												<div class="logCredential">
													<input type="text" name="conFPCaptchaText" type="text"
														cssClass="form-control" id="conFPCaptchaText"
														maxLength="10" placeholder="Enter Captcha here*" /> <span
														id="conFPCaptchaSpan"></span>
												</div>

												<!-- simple captcha for consultant forgot password login end -->
							...
							<div class="col-sm-4 col-sm-offset-1" id="col-sm-4">
								<div class="tabs">
									...
									<ul>
										...
										<li title="CSR / Admin Login"><label for="tab2"
											role="button"> <i class="fa fa-user"
												aria-hidden="true"></i><br> <span>CSR/Admin</span>
										</label></li>
								...
								<div class="modal-dialog login_wrapper" id="Form_login"
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<script type="text/javascript">
												$('#myLogin').modal('show');
												/* loadNewCaptcha("custLoginCaptcha"); */
											</script>
...
<button type="submit">LogIn</button>
												...
												<div class="col-sm-12">
													...
													<div class="col-sm-3" style="text-align: center">
														<span class="thumbnail animated bounceIn login_layout">
															...
															<h4>Customer</h4>
															<p class="item">Login to your Customer account to
																Post Jobs, Manage Job Applications, Projects,
																Timesheets, Invoices, Consultant Screening and
																Onboarding.</p>
															<hr class="line">
															<div class="row">

																<div class="col-md-12" data-dismiss="modal"
																	id="cus_login" aria-label="Close">
																	<button class="btn-lg col-md-12 btn-primary"
																		style="font-size: 16px;" data-toggle="modal"
																		data-target="#myLogin"
																		onclick="loadNewCaptcha('custLoginCaptcha');">Login</button>
																</div>
													...
													<div class="col-sm-3" style="text-align: center">
														<span class="thumbnail animated bounceIn login_layout">
															...
															<p class="item">Login to manage Customers, Vendors,
																Requirements, Profile Verifications and Approvals.</p>
															<hr class="line">
															<div class="row">

																<div class="col-md-12" data-dismiss="modal"
																	id="csr_login" aria-label="Close">
																	<button class="btn-lg col-md-12 btn-primary"
																		style="font-size: 16px;" data-toggle="modal"
																		data-target="#csrOrAdminLogin"
																		onclick="loadNewCaptcha('csrLoginCaptcha');">Login</button>
																</div>
													...
													<div class="col-sm-3" style="text-align: center">
														<span class="thumbnail animated bounceIn login_layout">
															...
															<p class="item">Login to your Vendor account to View
																Jobs, Submit Candidates, Manage Onboarding Process and
																Generate Invoices.</p>
															<hr class="line">
															<div class="row">
																...
																<div class="col-md-12" data-dismiss="modal"
																	...
																	<button class="btn-lg col-md-12 btn-primary"
																		style="font-size: 16px;" data-toggle="modal"
																		data-target="#vendorLogin"
																		onclick="loadNewCaptcha('venLoginCaptcha');">Login</button>
																</div>
													...
													<div class="col-sm-3 " style="text-align: center">
														<span class="thumbnail animated bounceIn login_layout">
															...
															<p class="item">
																Login to Submit your Profile, Required Documents, Attend
																Online Exams and Check Profile Status<br> <br>
															</p>
															<hr class="line">
															<div class="row">
																...
																<div class="col-md-12" data-dismiss="modal"
																	...
																	<button class="btn-lg col-md-12 btn-primary "
																		style="font-size: 16px;" data-toggle="modal"
																		data-target="#consultantLogin"
																		onclick="loadNewCaptcha('conLoginCaptcha');">Login</button>
																</div>
									...
									<div class="modal-content"
										...
										<div class="modal-header "
											...
											<h4 class="modal-title customerLogin" id="myModalLabel"
												style="color: white">Customer Login</h4>
										...
										<div class="modal-body customer_form">
											...
											%>
											<script type="text/javascript">
											 document.getElementById("captchaFlag").value="custLoginCaptcha"; 
											...
											<!-- showing invalid user or invalid captcha message when customer error message() is not equal to null -->
											<span id="custLoginCaptchaSpan"> <%
											...
											%>
											<!-- showing captcha error message when customer error message() is null -->
											<%
											if (request.getAttribute("customerErrorMessage") == null) {
											%>
											<span id="custLoginCaptchaSpan"></span>
											<%
												}
											%>
											...
											<div class="">
												<s:form action="/general/loginCheck.action" method="post"
													name="userLoginForm" id="userLoginForm"
													onsubmit="return simpCaptchaValidation('custLoginCaptchaText','custLoginCaptcha','custLoginCaptchaSpan')">
													...
													<!-- customer login google recaptcha -->
													<!-- <div id="customerRecaptcha" class="captcha_login"></div> -->
													<div class="captchaDiv">
														<%-- src="<s:url action='../users/general/getCaptchaImage?captchaFlag=custLoginCaptcha'/>" --%>
														<img alt="captcha image" id="custLoginCaptcha"
															style="float: left;" /> <i id="custLoginCaptchaRefbtn"
															class="fa fa-refresh fa-2x captchaRefreshBtn"
															onclick="loadNewCaptcha('custLoginCaptcha');"></i>

														<input type="text" name="custLoginCaptchaText" type="text"
															class="" id="custLoginCaptchaText" maxLength="10"
															placeholder="Enter Captcha here*" tabindex="3"
											...
											<div>
												<p id="wrapper" class="frgt_pwd">
													<a class="slide_open pull-right" href="" id="closeLogin"
														...
														onclick="loadNewCaptcha('CVFPCaptcha');"><font
														class="fgtPwd" style="text-align: right">Forgot
															password?</font></a>
												</p>
											</div>
											...
											<div class="row col-list">
												...
												<div class="col-md-4 t2 ">
													<div class=" " style="text-align: center">
														<a class="thumbnail animated bounceIn login_layout"
															id="headerRegisterCustLink"
															href="<%=request.getContextPath()%>/general/register.action?home=No&regFlag=ac">
												...
												<div class="col-md-4 t3 ">
													<div class=" " style="text-align: center">
														<a id="headerRegisterLink"
															class="thumbnail animated bounceIn login_layout"
						...
						<div class="login-form modal fade" id="csrOrAdminLogin"
							tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
							<div class="login_modal" id="Form_login" role="document">
								<div class="modal-content"
									style="background: rgba(0, 0, 0, 0) linear-gradient(135deg, rgba(235, 240, 246, 1) 0%, rgba(208, 230, 244, 1) 0%, rgba(208, 230, 244, 1) 100%, rgba(208, 230, 244, 1) 100%, rgba(208, 230, 244, 1) 100%, rgba(208, 230, 244, 1) 100%) repeat scroll 0 0">
									...
									<div class="modal-body csrOrAdmin_form">
										...
										%>
										<script type="text/javascript">
										document.getElementById("captchaFlag").value="csrLoginCaptcha";
											if ($(window).width() > 641) {
										...
										<%
											if (request.getAttribute("csrOrAdminErrorMessage") == null) {
										%>
										<span id="csrLoginCaptchaSpan"></span>
										<%
											}
										%>
										...
										<div class="">
											<s:form action="/general/loginCheck.action" method="post"
												name="userLoginForm" id="userLoginForm"
												onsubmit="return simpCaptchaValidation('csrLoginCaptchaText','csrLoginCaptcha','csrLoginCaptchaSpan')">
												...
												<!-- Google recaptcha for csr or admin login -->
												<%-- <div id="csrOrAdminReCaptcha" class="captcha_login"></div>
												<!-- style="margin: 0 auto;display: table" -->

												<span id="csrOrAdminReCaptchaSpan"></span> --%>

												<!-- simple captcha for csr login start -->
												<%-- src="<s:url action='../users/general/getCaptchaImage?captchaFlag=csrLoginCaptcha'/>" --%>
												<div class="captchaDiv">
													<img alt="captcha image" id="csrLoginCaptcha"
														style="float: left" /> <i
														class="fa fa-refresh fa-2x captchaRefreshBtn"
														onclick="loadNewCaptcha('csrLoginCaptcha');"></i>

													<input type="text" name="csrLoginCaptchaText" type="text"
														id="csrLoginCaptchaText" maxLength="10"
														placeholder="Enter Captcha here*" tabindex="3"
														style="width: 200px; margin-top: 10px;" />

												</div>

												<div class="logCredential"></div>

												<!-- simple captcha for vendor login end -->
							...
							<div class="login_modal" id="Form_login" role="document">
								<div class="modal-content"
									...
									<div class="modal-body vendor_form">
										...
										%>
										<script type="text/javascript">
										document.getElementById("captchaFlag").value="venLoginCaptcha";
											if ($(window).width() > 641) {
										...
										<span id="venLoginCaptchaSpan"></span>

										<div class="">
											<s:form action="/general/loginCheck.action" method="post"
												name="userLoginForm" id="userLoginForm">
												<%--onsubmit="return simpCaptchaValidation('venLoginCaptchaText','venLoginCaptcha','venLoginCaptchaSpan')">
												...
												<div class="logCredential">
													<i class="fa fa-envelope"></i> <input type="email"
														placeholder="Email" class="frgt_pwd" name="emailId"
														id="emailIdVendor" pattern="[^@]+@[^@]+\.[a-zA-Z]{2,6}" required
														data-error-message="LoginId is required!" tabindex="1" />
												</div>
												...
												<!-- Google recaptcha for vendor login -->
												<%-- <div id="vendorRecaptcha" class="captcha_login"></div>
												<!-- style="margin: 0 auto;display: table" -->

												<span id="vendorReCaptchaSpan"></span> --%>

												<!-- simple captcha for vendor login start -->

												<div class="captchaDiv">
													<%-- src="<s:url action='../users/general/getCaptchaImage?captchaFlag=venLoginCaptcha'/>" --%>

													<img alt="captcha image" id="venLoginCaptcha"
														style="float: left" /> <i
														class="fa fa-refresh fa-2x captchaRefreshBtn"
														<!-- onclick="loadNewCaptcha('venLoginCaptcha');"-->  ></i>

													<input type="text" name="venLoginCaptchaText" type="text"
														class="" id="venLoginCaptchaText" maxLength="10"
														placeholder="Enter Captcha here*" tabindex="3"
														style="width: 200px; margin-top: 10px;" />
												...
												<div class="row" style="margin: 0px 5px">
													<div class="LoginButton pull-left">
										<button type="submit" class="btn btn-primary" id="vendorsLogin">LogIn</button>
													</div>
													<div class="LoginButton pull-right reg_btn">
														<a
															href="<%=request.getContextPath()%>/general/register.action?home=No&regFlag=vc"
							...
							<div class="login_modal" id="Form_login" role="document">
								<div class="modal-content"
									...
									<div class="modal-body consultant_form"
										...
										%>
										<script type="text/javascript">
										document.getElementById("captchaFlag").value="conLoginCaptcha";
											if ($(window).width() > 640) {
												$('#consultantLogin').modal(
														'show');
												loadNewCaptcha("conLoginCaptcha");
											} else {
												$('#tab1').prop('checked',
														false);
												$('#tab2').prop('checked',
										...
										<span id="conLoginCaptchaSpan"></span>
										...
										<div class="">
											<s:form action="/general/consultantLoginCheck.action"
												...
												onsubmit="return simpCaptchaValidation('conLoginCaptchaText','conLoginCaptcha','conLoginCaptchaSpan')">
												...
												<!-- Google recaptcha for consultant login -->
...
id="captchaCheckSpan1"></span>
										...
										<!-- simple captcha for consultant login start -->

										<div class="captchaDiv">
											<%-- src="<s:url action='../users/general/getCaptchaImage?captchaFlag=conLoginCaptcha'/>" --%>
											<img alt="captcha image" id="conLoginCaptcha"
												style="float: left" /> <i
												class="fa fa-refresh fa-2x captchaRefreshBtn"
												onclick="loadNewCaptcha('conLoginCaptcha');"></i>

											<input type="text" name="conLoginCaptchaText" type="text"
												class="" id="conLoginCaptchaText" maxLength="10"
												placeholder="Enter Captcha here*" tabindex="3"
												style="width: 200px; margin-top: 10px;" />
										...
										<!-- simple captcha for consultant login end -->
										...
										<div>
											<p id="wrapper" class="frgt_pwd">
												<a class="consultantSlide_open pull-right" href=""
													...
													data-target="#forgotPwd"
													onclick="loadNewCaptcha('conFPCaptcha');"><font
													class="fgtPwd" style="text-align: right">Forgot
														password?</font></a>
											</p>
										</div>
