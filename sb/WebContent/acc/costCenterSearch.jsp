...
<html>
    ...
    <body oncontextmenu="return false" onload="getSearchCostCenterList('1');doOnLoadCostCenter();">
        <div id="wrap">
                                    ...
                                    <div class="" id="profileBox" style="float: left; margin-top: 5px">
                                            ...
                                            <div class="inner-reqdiv-elements">
                                                ...
                                                <div class="row">  
                                                    <div class="col-sm-4 pull-right">
                                                        ...
                                                        <div class="col-sm-6 ">
                                                            <label class="labelStylereq" style="color:#56a5ec"></label>
                                                            <s:submit id="costCenterSearchButton" cssClass="add_searchButton form-control" type="button" value="" cssStyle="margin:5px 0px 0px" onclick="getSearchCostCenterList('1');"><i class="fa fa-search"></i>&nbsp;Search</s:submit> 
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <s:form>
                                            ...
                                            <s:hidden name="pgNo" id="pgNo"/>
												<s:hidden name="ccTotalRecords" id="ccTotalRecords"/>
                                            ...
                                            <div class="task_content" id="task_div" align="center" style="display: none" >
                                                ...
                                                <div>
                                                    <div>
                                                        ...
                                                        <br/>
                                                            <label class="page_option"> Display<select id="paginationOption" class="disPlayRecordsCss" onchange="getSearchCostCenterList('1')" style="width: auto">
                                                                    <option>10</option>
                                                                    <option>15</option>
                                                                    <option>25</option>
                                                                    <option>50</option>
                                                        ...
                                                        <span id="ccList_pageNation"></span>
