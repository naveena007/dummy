...
<html>
    <head>
        ...
        <title>ServicesBay :: Vendor Association</title>
																				...
																				<div id="editVendorTier_popup">
																					<div id="EditVendorTierOverlay">
																						...
																						<div id="VendorTierDiv">
																							<span><e1></e1></span>
																							<div class="innerAddConElements">
																							<label class="labelStyleAddCon">Customer</label> 
																							...
																							<div class="innerAddConElements">
																							<label class="labelStyleAddCon">Vendor</label> 
																										<s:textfield cssClass="form-control"
																											id="vendorName"
																											name="vendorName"
																											readonly="true" />
                                         ...
                                         <div class="backgroundcolor" >
                                            <div class="panel-heading">
                                                <h4 class="panel-title">
                                                    <font color="#ffffff">Customer Vendor Association</font>
                                                    </h4>
                                                </div>
                                            </div>
                                            <br>
																				...
																				<div class="col-sm-3">
											 <label class="labelStyle">Customer</label>
													<s:select cssClass="SelectBoxStyles form-control"
														...
														list="csrCustomerList" />
																					...
																					<div class="col-sm-3">
																						<label class="labelStyle" style="color: #56a5ec">Vendor
																							 Tiers</label>
