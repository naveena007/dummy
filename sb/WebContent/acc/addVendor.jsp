...
//});
    ...
    <body oncontextmenu="return false" onload="doOnLoad();">
                                ...
                                <div class="features_items">
                                    <div class="" id="profileBox" style="float: left; margin-top: 5px">
                                        ...
                                        <div class="inner-reqdiv-elements">
                                            ...
                                            <div class="row">
                                            <div class="col-sm-3">
											 <label class="labelStylereq required_label">Customer Name</label>
													<s:select cssClass="SelectBoxStyles form-control"
														name="customerList" id="customerList"
														headerKey="" headerValue="Select Customer"
														list="csrCustomerList" />
														<span id="customerValidation"></span>
											</div>
                                                <div class="col-sm-3">
                                                ...
                                                <div class="col-sm-3">
                                                    ...
                                                    <s:select cssClass="SelectBoxStyles form-control " name="vendorTier" id="vendorTier" headerKey="0" headerValue="Select Tier" list="vendorTierMap"/>
                                                </div>
                                                <div class="col-sm-2">
        ...
        <div style="display: none; position: absolute; top:200px;left:460px;overflow:auto; z-index: 1900000" id="menu-popup">
