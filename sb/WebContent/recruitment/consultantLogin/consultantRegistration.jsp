...
<body oncontextmenu="return false">
								...
								<div class="col-sm-12" style="margin-bottom: 20px">
									...
									<s:form action="doConsultantRegistration" method="post"
										...
										<div class="col-sm-4">
											...
											<s:select cssClass="form-control" type="text" class="SelectBoxStyles"
									...
									<%--Google re captcha --%>
										<%-- <div class="col-sm-4">
 										...
 										--%>
										<div class="col-sm-4">
											<img alt="captcha image" src="<s:url action='../users/general/getCaptchaImage?captchaFlag=conReg'/>"
												id="conReg" /> <i onclick="loadNewCaptcha('conReg');" class="fa fa-refresh fa-2x" style="position:absolute;top:15%;color:darkGray;cursor: pointer;"></i>
											<s:textfield name="consultantCaptchaText" type="text"
												cssClass="form-control" id="consultantCaptchaText"
												maxLength="10" placeholder="Enter Captcha Here*" />
											<span id="conRegRecaptchaSpan"></span>		
										</div>
										<%-- <div class="col-sm-4 required" style="margin: 0">
											<label class="labelStyle2">Enter Captcha Here</label>
											<s:textfield name="consultantCaptchaText" type="text"
												cssClass="form-control" id="consultantCaptchaText"
												maxLength="60" placeholder="Captcha" />
											<span id="conRegRecaptchaSpan"></span>
										</div>
 										--%>
										<br/>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<s:form action="/general/consultantLoginCheck.action" method="post"
					...
					<!-- Google recaptcha for consultant login in registration page -->
					<%-- <div id="conLoginRecaptcha"></div>

					<span id="conLoginRecaptchaSpan"></span> --%>

					<div style="background-color:whitesmoke;border-radius:9px;text-align:center">
					<img alt="captcha image"
						src="<s:url action='../users/general/getCaptchaImage?captchaFlag=conLoginRegCaptcha'/>"
						id="conLoginRegCaptcha"/>
					<i onclick="loadNewCaptcha('conLoginRegCaptcha');" class="fa fa-refresh fa-2x"
						style="color:darkGray; cursor: pointer;position:absolute;margin-top:3%"></i>
					</div>	
					<div class="logCredential">
						<input type="text" name="conLoginRegCaptchaText" type="text"
							 class="frgt_pwd" id="conLoginRegCaptchaText" maxLength="10"
							placeholder="Enter Captcha Here*"/>
						
					</div>
					<div class="logCredential">
					<span id="conLoginRegCaptchaSpan" style="font-size:10pt"></span>
					</div>	
	...
	<div id="consultantForgotPwdslide" class="">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div>
				<span id="Loading" style="color: red; width: auto;display:none">Loading....</span> 
				...
				<s:form id="forgotPassword" name="forgotPassword" theme="simple">
					...
					<!-- Google recaptcha for consultant forgot password in registration -->
					...
					<div style="background-color:whitesmoke;border-radius:9px;text-align:center">
					<img alt="captcha image"
						src="<s:url action='../users/general/getCaptchaImage?captchaFlag=conFPRegCaptcha'/>"
						id="conFPRegCaptcha" />
					<i onclick="loadNewCaptcha('conFPRegCaptcha');"
						class="fa fa-refresh fa-2x"
						style="color: darkGray; cursor: pointer;position:absolute;margin-top:5%"></i>
						</div>
						<br>
					<div class="logCredential">
						<input type="text" name="conFPRegCaptchaText"
							class="frgt_pwd" id="conFPRegCaptchaText"
							maxLength="10" placeholder="Enter Captcha Here*" />
					</div>  
					<br>
					<div>                    
