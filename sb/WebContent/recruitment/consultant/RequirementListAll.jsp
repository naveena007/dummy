...
<body style="overflow-x: hidden" oncontextmenu="return false"
	onload="doOnLoadReqList();loadPopup();getSearchRequirementsList(1)">
	<div id="wrap">
		<header id="header">
			<!--header-->
				...
				<div id="addVendorConsultantOverlay">
					<div style="background-color: #3bb9ff; padding: 0px">
						<table>
							<tr>
								<td><h4 style="">
										<font color="#ffffff">&nbsp;&nbsp;Add Consultant
											Details&nbsp;&nbsp; </font>
									</h4></td>
							</tr>
							<span class=" pull-right"><h5>
									<a href="#" class="addVendorConsultant_popup_close"
										onclick="storeReqIdinOverlay(21)"><i
						...
						<s:form action="" theme="simple">
							<div id="mainAddConsultantDiv">
								...
								<div class="innerAddConElements">
									...
									<label class="labelStyleAddCon">Email</label>
									<s:textfield name="email" id="conEmail" theme="simple"
										cssClass="addConInputStyle" onblur="getEmailExistance();"
										onclick="clearConultantAddOverlay()" />
									<font color="red">*</font>
								</div>
								<div class="innerAddConElements">
									<label class="labelStyleAddCon">ProofType</label>
									<s:select id="proofType" cssClass="reqSelectStyle"
										name="proofType"
										list="#@java.util.LinkedHashMap@{'N':'--Select--','PN':'PAN','PP':'Passport'}"
										onchange="setPPorPAN(this.value);"
										onclick="clearConultantAddOverlay()" />
								</div>
								<div>
									<div class="innerAddConElements" id="ppId">
										<label class="labelStyleAddCon">PassPortNo</label>
										<s:textfield name="ppno" id="ppno" theme="simple"
											cssClass="addConInputStyle"
											onclick="clearConultantAddOverlay()" />
									</div>
									<div class="innerAddConElements" id="panId">
										<label class="labelStyleAddCon">Pan no</label>
										<s:textfield name="pan" id="pan" theme="simple"
											cssClass="addConInputStyle"
											onclick="clearConultantAddOverlay()" />
									</div>
									<div class="innerAddConElements">
										<label class="labelStyleAddCon">Rate/Hr</label><span>$</span>
										<s:textfield name="ratePerHour" id="ratePerHour"
											theme="simple" cssClass="addConInputStyle80"
											onclick="clearConultantAddOverlay()" />
										<font color="red">*</font>
									</div>
								</div>
								<div class="pull-right">
									<s:submit id="addConSubmit" cssClass="cssbutton" value="Submit"
										onclick="return storeProofData()" />
								</div>
							</div>
						</s:form>
					</div>
                                ...
                                <div class="features_items">
													...
													<s:if test="vendor!='yes'">
																<div class="col-sm-4">
																	...
																	<s:select id="requirementStatus"
																		name="requirementStatus" tabindex="8"
																		cssClass="SelectBoxStyles form-control" headerKey="-1"
																		headerValue="All" theme="simple"
																		list="#@java.util.LinkedHashMap@{'O':'Opened','R':'Released','OR':'Open for Resume','C':'Closed','F':'Forecast','I':'Inprogess','H':'Hold','W':'Withdrawn','S':'Won','L':'Lost'}" />
																</div>

																<div class="col-sm-4">
																	<label class="labelStylereq" style="color: #56a5ec;">Start
																		Date</label>
																	<div class="calImage">
																		<s:textfield cssClass=" form-control " name="reqStart"
																			id="reqStart" placeholder="FromDate" tabindex="9"
																			onkeypress="return enterDateRepository(this);"
																			onfocus="return removeEndDateErrorMsg();">
																			<i class="fa fa-calendar"></i>
																		</s:textfield>
																	</div>
																</div>
																<div class="col-sm-4">
																	<label class="labelStylereq" style="color: #56a5ec;">End
																		Date</label>
																	<div class="calImage">
																		<s:textfield cssClass=" form-control " name="reqEnd"
																			placeholder="ToDate" id="reqEnd" tabindex="10"
																			onkeypress="return enterDateRepository(this);"
																			onfocus="return removeEndDateErrorMsg();">
																			<i class="fa fa-calendar"></i>
																		</s:textfield>
															...
															<div class="col-sm-6">
																...
																<s:select cssClass="" name="skillCategoryValue"
																	tabindex="11" id="skillCategoryValue"
															...
															<div class="col-sm-6 pull-right">
																...
																<div class="pull-right btn_alignment">
																	...
																	<s:submit type="button"
																		...
																		tabindex="12" id="requirementsListSearch"
																		value="Search"
																...
																<div class="pull-right btn_alignment">
																	...
																	<s:if test="#session.primaryrole==3">
																		<s:url id="myUrl"
																			action="/../../../Requirements/addRequirements.action">
																		...
																		<label class="labelStylereq" style="color: #56a5ec;"></label>
																		<s:a href='%{#myUrl}' id="requirementAdd"
																			cssClass="add_searchButton form-control contact_search"
																			tabindex="13" style="margin:5px">
																			<i class="fa fa-plus-square"></i>&nbsp;Add</s:a>
																	</s:if>
									...
									<div class="col-sm-12  share">
										<s:form>
											...
											<div class="task_content form-control col-sm-12"
												id="task_div" align="center" style="display: none">
												...
												<table id="reqTableInRecruiter"
													...
													<tbody>
														<tr>
															...
															<s:elseif test="#session.primaryrole == 1">
																<th>Customer</th>
																<th width="11%">No.of Positions</th>
															</s:elseif>
															...
															<s:elseif test="#session.primaryrole == 1">
																<th width="11%">No.Of&nbsp;Submissions</th>
																<th class="unsortable">Release to vendors</th>
															</s:elseif>
															<s:else>
 ...
 --%>
												...
												<br /> <label class="page_option"> Display <select
													...
													onchange="getSearchRequirementsList(1)" style="width: auto">
														<option>10</option>
														<option>15</option>
														<option>25</option>
														<option>50</option>
												</select> Requirements per page
												</label> <span id="button_pageNation"></span>
 ...
 --%>
											...
											<div class="col-sm-12">
												<div id="downloading_grid" class="col-sm-6 pull-right">
													<div class="pull-right  req_btn col-sm-0"
														...
														<div onclick="downloadPDFRequirementList()" tabindex="14"
															class="fa fa-download cssbutton form-control">&nbsp;DownloadPDF</div>
													</div>
													<div class="pull-right  req_btn col-sm-0">
														<div onclick="downloadXLSRequirementList()" tabindex="15"
								...
								<div id="recruiterOverlay_popup">
													...
													<span class="pull-right">
														<h5>
															&nbsp;&nbsp;&nbsp;&nbsp;<a href=""
																...
																onclick="closeRecruiterOverlay()"><i
																class="fa fa-times-circle-o fa-size"></i></a>
														</h5>
													</span>
											</table>
										...
										<div>
											<center>
												<table>
													...
													<s:textfield label="Phone" cssClass="form-control margin"
									...
									<div id="releaseVendorOverlay_popup">
										<div id="releaseVendorBox" class="marginTasks">
														...
														<span class="pull-right">
															<h5>
																&nbsp;&nbsp;&nbsp;&nbsp;<a href=""
																	...
																	onclick="selectVendorsOverlayClose();getSearchRequirementsList(1);"><i
																	class="fa fa-times-circle-o fa-size"></i></a>
															</h5>
														</span>
												</table>
											...
											<div>
												<table id="releaseReqTable" class="responsive" border="0"
													cell-spacing="1"
													style="overflow-x: auto; overflow-y: hidden; margin: 11px 3%; width: 94%;">
													<tr style="color: #3478c6">
														<th><div class="hb3">
																<div style="text-align: left;">
																	<i class="fa fa-file-text" aria-hidden="true"></i>&nbsp;Associated
																	Vendors
																</div>
															</div></th>
													</tr>
												...
												<div class="row">
													<div class="col-md-12">
														<div class="col-md-6"
															...
															<s:checkbox cssClass="checkboxAlign" name="allVendors"
																id="allVendors" onclick="onClickHandler(this)" />
															&nbsp;&nbsp;
														...
														<div class="col-md-6">
															<div style="cursor: pointer; display: none"
																onclick="doReleaseRequirement()"
																id="vendorReleaseButton"
																class=" fa fa-arrow-circle-o-right cssbutton pull-right">&nbsp;Release</div>
														</div>
													</div>
												</div>
												...
												<label style="margin: 2% 0 0 3%" class="pull-right">
													...
													onchange="releaseReqPagerOption();" style="width: auto">
														<option>10</option>
														<option>15</option>
														<option>20</option>
														<option>25</option>
												...
												<div class="main-login-form">
													<div class="login-group">
														<div class="form-group1">
															...
															<p>
																* <b>Tier-1 Associated Vendors</b> : If the requirement
																is <b>Contract</b> then initially requirement will be
																released to Tier-1 Vendors.
															</p>
															<p>
																* <b>HeadHunters</b> : If the requirement is <b>Fulltime</b>
																then initially requirement will be released to
																HeadHunters
															</p>
															<p>
																* <b>All Vendors </b>: Select All Vendors to release
																this requirement to every vendor associated with this
																Customer.
															</p>
								...
								<div id="addAuthAccOverlay_popup">
									<div id="addAuthAccBox">
										<div class="backgroundcolor">
											<table>
												<tr>
													<td><h4 id="" style="font-family: cursive ;margin:10px">
															<font id="overlayHeading" class="titleColor">Security
																Deposit Policy</font>
														</h4></td>
													<span class="pull-right">
														<h5>
															&nbsp;&nbsp;&nbsp;&nbsp;<a href=""
																id="authAddCloseButton"
																class="addAuthAccOverlay_popup_close"
																onclick="securityDepoReqOverlayClose();"><i
																class="fa fa-times-circle-o fa-size"></i></a>
														</h5>
													</span>
											</table>
										...
										<div>
											...
											<s:hidden id="overlayReqId" name="overlayReqId" />
											<s:hidden id="overlayOrgId" name="overlayOrgId" />
                                ...
                                <div class="inner-addAcc-elements required" id="">
                                 ...
                                 --%>
                                 <div class="overlayFormFields ">
                                 <label class="addAcclabelStyle" style="color: #56a5ec;">Do you want to add Security deposit policy <br>to this requirement ?</label>
                                <br> <s:radio cssStyle=""  name="securityDepoCheck" id="securityDepoCheck" list="#{'1':'Yes','2':'No'}" value="2" onchange="enableOrDisableSecurityDepo(this.value);"/>
										</div>
											<div id="securityDepoDiv" style="display: none;">
											
											<div class="overlayFormFields required" id="">
												<label class="addAcclabelStyle" style="color: #56a5ec;">Security Deposits</label>
												<s:select id="overlaySecurityDepositList"
													cssClass="form-control SelectBoxStyles" headerKey="-1" 
													headerValue="Please Select" name="overlaySecurityDepositList"
													list="{}" onchange="return getSecurityDepoForReq();"
													 />
											</div>
											
											
											<div class="overlayFormFields required" id="">
												<label class="addAcclabelStyle" style="color: #56a5ec;">Profile
													Submission Cost ($)</label>
											...
											<div class="overlayFormFields required" id="">
												<label class="addAcclabelStyle" style="color: #56a5ec;">Profile
													Selected Cost ($)</label>
												<s:textfield id="overlayProfileSelectedCost"
													cssClass="form-control" type="text"
													name="overlayProfileSelectedCost"
													placeholder="Profile Selected Cost"
													onkeyup="rateValidation(this);" />
											</div>

											<div class="overlayFormFields required" id="">
												<label class="addAcclabelStyle" style="color: #56a5ec;">Profile
													Rejection Cost ($)</label>
											...
											<div class="overlayFormFields required" id="">
												<label class="addAcclabelStyle" style="color: #56a5ec;">Fake
													Candidate Fine ($)</label>
											...
											<div class="overlayFormFields required" id="descDiv">
												<label class="addAcclabelStyle" style="color: #56a5ec;">Comments
												</label>
												<s:textarea id="overlayComments" cssClass="form-control"
													name="overlayComments" placeholder="Enter Comments Here"
													onkeydown="actionAuthDescription(this)"
...
<div class="col-sm-5 pull-right" id="releaseBtnDiv">
												<button type="button" id="releaseBtn"
													
													class="add_searchButton  form-control"
													onclick="SendReqNotificationToCSR();" value="">
													<i class="fa fa-arrow-circle-o-right fa-size"></i>&nbsp;Release
												</button>
											</div>
										</div>
									</div>
								...
								<%-- end overlay for Security deposit  --%>
	...
	<script type="text/javascript">
		...
		function releaseReqPagerOption() {
			...
			var paginationSize = document
					.getElementById("paginationOption_releaseReq").value;
			if (isNaN(paginationSize)) {
